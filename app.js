...
const CV = [
  ...
  makePet('Gargantuan Santa Paws', '85770840304413',  'Gargantuan', C, 222082603353),
  ...
  makePet('Gargantuan Floppa', '100320985111822', 'Gargantuan', C, 206105077430),
  ...
  makePet('Gargantuan Wise Cat', '83925987845910',  'Gargantuan', C, 192765417513),
  ...
  makePet('Gargantuan Special Ops Moth', '91565856235548',  'Gargantuan', C, 173750206417),
  makePet('Gargantuan Grim Reaper', '108242446619492', 'Gargantuan', C, 175968489457),
  makePet('Gargantuan Totem Monkey', '119822736449264', 'Gargantuan', C, 172417337549),
  makePet('Gargantuan Dawn Phoenix', '77286983181517',  'Gargantuan', C, 166365565445),
  makePet('Gargantuan Magma Spirit', '132074129972033', 'Gargantuan', C, 163267212755),
  makePet('Gargantuan Bloom Dominus', '113165518550651', 'Gargantuan', C, 163744471303),
  makePet('Gargantuan Leafy Deer', '93500762936904',  'Gargantuan', C, 162169588678),
  ...
  makePet('Gargantuan Glass Squid', '114884121622306', 'Gargantuan', C, 149456631501),
  makePet('Gargantuan Lucki Angelus', '126822762417464', 'Gargantuan', C, 135656207634),
  makePet('Gargantuan Skelemelon', '116658660548384', 'Gargantuan', C, 135094750069),
  makePet('Gargantuan Blurred Agony', '72042454012987',  'Gargantuan', C, 134199570342),
  makePet('Gargantuan Fluffy Cat', '122984499289928', 'Gargantuan', C, 127883409391),
  makePet('Gargantuan Evil Scarecrow Pumpkin', '114300365192444','Gargantuan', C, 127471678366),
  makePet('Gargantuan Cappuccino Brainrot', '126301320280051', 'Gargantuan', C, 124150248385),
  makePet('Gargantuan Treasure Angelus', '100287069484548', 'Gargantuan', C, 123620082332),
  makePet('Gargantuan Elf Golem', '83433844494349',  'Gargantuan', C, 122677322927),
  makePet('Gargantuan Gingerbread Angelus', '88769910454037',  'Gargantuan', C, 118851857413),
  makePet('Gargantuan Snowflake Dragon', '118532711191840', 'Gargantuan', C, 118839287806),
  makePet('Gargantuan Black Balloon Cat', '70419388027416',  'Gargantuan', C, 116230447155),
  makePet('Gargantuan Leprechaun Fox', '82088505811077',  'Gargantuan', C, 115811608305),
  makePet('Gargantuan Krampus', '128217268096438', 'Gargantuan', C, 115708344336),
  makePet('Gargantuan Nightfall Tiger', '106417356158790', 'Gargantuan', C, 113607835741),
  makePet('Gargantuan Cookie Cut Cat', '124818572217039', 'Gargantuan', C, 111634232038),
  makePet('Gargantuan Super Cat', '128024931288917', 'Gargantuan', C, 111526458585),
  makePet('Gargantuan Origami Kitsune',      '116438972015691', 'Gargantuan', C,  126830518209),
  makePet('Gargantuan Hypnotic Kitsune',     '130525621588743', 'Gargantuan', C,  750000000000),
  makePet('Gargantuan Royal Beast',          '120268942762821', 'Gargantuan', C,  530000000000),
  makePet('Gargantuan Nyan Cat',             '102598468729073', 'Gargantuan', C,  50000000000),

  /* -- TITANIC -- (real data from db.biggames.io, PSG = RAP/100) */
  makePet('Titanic Hippomelon', '14976631515'     , 'Titanic', T, 662127258835),
  makePet('Titanic Pink Balloon'                , '14976657520'     , 'Titanic', T, 264713004561),
  makePet('Titanic Luxe Axolotl', '75796665600934'  , 'Titanic', T, 163564772626),
  makePet('Titanic Blueberry Cow', '17269862161'     , 'Titanic', T, 126624256801),
  makePet('Titanic Nightmare Cat', '15260478604'     , 'Titanic', T, 118172422237),
  makePet('Titanic Wild Corrupt Agony', '103464099228930' , 'Titanic', T, 105723463444),
  makePet('Titanic Dominus Darkwing', '76103751008934'  , 'Titanic', T, 104985490455),
  makePet('Titanic Corgi'                              , '16125357082'      , 'Titanic', T, 12142513526),
  makePet('Titanic Cat', '14976594978'     , 'Titanic', T, 98159649299),
  makePet('Titanic Ghostface Cat', '119318487422826' , 'Titanic', T, 95464464847),
  makePet('Titanic Blobfish', '14976589636'     , 'Titanic', T, 92082165848),
  makePet('Titanic Sad Cat', '14976666952'     , 'Titanic', T, 83698623551),
  makePet('Titanic Arcane Pyro Cat', '18978058000'     , 'Titanic', T, 66787307517),
  makePet('Titanic Atlantean Jellyfish', '14976584980'     , 'Titanic', T, 63850084793),
  makePet('Titanic Black Hole Angelus', '17285296068'     , 'Titanic', T, 62815023140),
  makePet('Titanic Neon Agony', '14976647939'     , 'Titanic', T, 62232072534),
  makePet('Titanic SpongeBob SquarePants', '18313091924'     , 'Titanic', T, 62529437018),
  makePet('Titanic Poseidon Axolotl', '80369065406332'  , 'Titanic', T, 52473981771),
  makePet('Titanic Arcane Cat', '18882936169'     , 'Titanic', T, 52628271633),
  makePet('Titanic Jelly Dragon', '16483343520'     , 'Titanic', T, 50839591217),
  makePet('Titanic Jelly Cat', '14976635882'     , 'Titanic', T, 49446377226),
  makePet('Titanic Starry Owl', '90300371601451'  , 'Titanic', T, 47125833888),
  makePet('Titanic Jolly Cat', '17787600314'     , 'Titanic', T, 43764516889),
  makePet('Titanic Cartoon Cat', '96042514794947'  , 'Titanic', T, 40611920613),
  makePet('Titanic Lovemelon', '16306754796'     , 'Titanic', T, 41105738686),
  makePet('Titanic Kawaii Cat', '16393812743'     , 'Titanic', T, 40657500183),
  makePet('Titanic Angel Cow', '92969844303384'  , 'Titanic', T, 36386444285),
  makePet('Titanic Abstract Dominus'            , '111308527700884' , 'Titanic', T, 39989999900),
  makePet('Titanic Silver Dragon', '15687351099'     , 'Titanic', T, 39002530297),
  makePet('Titanic Balloon Monkey', '14976586764'     , 'Titanic', T, 37753634737),
  makePet('Titanic Bat Cat', '16746763420'     , 'Titanic', T, 37703463279),
  makePet('Titanic Silver Stag', '139456404804245' , 'Titanic', T, 37777017709),
  makePet('Titanic Valkyrie Pegasus', '18465212052'     , 'Titanic', T, 36701809984),
  makePet('Titanic Cosmic Pegasus', '15201628877'     , 'Titanic', T, 35763204240),
  makePet('Titanic Clover Owl', '94606595966896'  , 'Titanic', T, 35430939412),
  makePet('Titanic Sketch Cat', '17027114400'     , 'Titanic', T, 36530762600),
  makePet('Titanic Hubert', '14976633736'     , 'Titanic', T, 37122793278),
  makePet('Titanic Sun Angelus', '128663320518794' , 'Titanic', T, 33501072092),
  makePet('Titanic Red Balloon Cat', '14976586155'     , 'Titanic', T, 32268751159),
  makePet('Titanic Blue Balloon Cat', '14976589786'     , 'Titanic', T, 31309628297),
  makePet('Titanic Strawberry Cow', '14976827001'     , 'Titanic', T, 31213197997),
  makePet('Titanic Blazing Dragon', '17749522423'     , 'Titanic', T, 29942999328),
  makePet('Titanic Mystic Corgi', '14976647316'     , 'Titanic', T, 28613788698),
  makePet('Titanic Bread Shiba', '16393819211'     , 'Titanic', T, 27788119112),
  makePet('Titanic Spectral Deer', '131625375967545' , 'Titanic', T, 26751798814),
  makePet('Titanic Firegel Dragon', '84658799668641'  , 'Titanic', T, 27580034972),
  makePet('Titanic Hologram Cat', '14976631845'     , 'Titanic', T, 27084994750),
  makePet('Titanic Stargazing Bull', '17602420874'     , 'Titanic', T, 27229533311),
  makePet('Titanic Dominus Astra', '14976605624'     , 'Titanic', T, 25388691227),
  makePet('Titanic Fire Dragon', '15163496528'     , 'Titanic', T, 25109552499),
  makePet('Titanic Emoji Corgi', '16047477969'     , 'Titanic', T, 25324825590),
  makePet('Titanic Soul Owl', '125310152380772' , 'Titanic', T, 25002639315),
  makePet('Titanic Midnight Lion', '87889546587335'  , 'Titanic', T, 24734022541),
  makePet('Titanic Angry Yeti', '118155614090525' , 'Titanic', T, 23248190594),
  makePet('Titanic Wild Frost Agony', '116274982839546' , 'Titanic', T, 23078419174),
  makePet('Titanic Pop Cat', '107955973846092' , 'Titanic', T, 22114878419),
  makePet('Titanic Nightfall Pegasus', '18640616333'     , 'Titanic', T, 22626952028),
  makePet('Titanic Pumpkin Cat', '111326774282264' , 'Titanic', T, 22289397666),
  makePet('Titanic Yin-Yang Grim Reaper', '136807974742699' , 'Titanic', T, 22336123270),
  makePet('Titanic Pixel M-2 PROTOTYPE', '78274935877224'  , 'Titanic', T, 21873372913),
  makePet('Titanic Starfall Dragon', '70374143407469'    , 'Titanic', T, 21717751428),
  makePet('Titanic Capybara', '14976593327'     , 'Titanic', T, 21293136664),
  makePet('Titanic Vampire Agony', '120127746226502' , 'Titanic', T, 20134167548),
  makePet('Titanic M-14 PROTOTYPE', '99810281877777'  , 'Titanic', T, 20385629623),
  makePet('Titanic Valentines Cat'              , '16234782048'     , 'Titanic', T, 21548172796),
  makePet('Titanic Dot Matrix Kitsune', '101711904618223' , 'Titanic', T, 20950687468),
  makePet('Titanic Snow Globe Cat', '101380058502586' , 'Titanic', T, 19951686293),
  makePet('Titanic Nightmare Corgi', '137580301485992' , 'Titanic', T, 19635849512),
  makePet('Titanic Tiedye Dragon', '15547792197'     , 'Titanic', T, 19583131203),
  makePet('Titanic Love Lamb', '16234774596'     , 'Titanic', T, 19719018843),
  makePet('Titanic Lucki', '14976642572'     , 'Titanic', T, 19807055330),
  makePet('Titanic Tiedye Cat', '15547792344'     , 'Titanic', T, 19279443455),
  makePet('Titanic Bejeweled Griffin', '17450302814'     , 'Titanic', T, 19083561834),
  makePet('Titanic Nightfall Wolf', '16394133066'     , 'Titanic', T, 18693674711),
  makePet('Titanic Signature BIG Maskot', '87601095664895'  , 'Titanic', T, 18669614057),
  makePet('Titanic Kaiju Moth', '119404602163936' , 'Titanic', T, 18608581242),
  makePet('Titanic Banana Cat', '15644507059'     , 'Titanic', T, 18379736112),
  makePet('Titanic Flex Cat', '18151232769'     , 'Titanic', T, 18310554616),
  makePet('Titanic Chad Gorilla', '101924214050321' , 'Titanic', T, 18100727559),
  makePet('Titanic Samurai Dragon', '125481811562940' , 'Titanic', T, 18075915907),
  makePet('Titanic Rich Cat', '17194508969'     , 'Titanic', T, 18007060246),
  makePet('Titanic Shadow Griffin', '14976670848'     , 'Titanic', T, 17417582313),
  makePet('Titanic Butterfly', '17821211666'     , 'Titanic', T, 17781866502),
  makePet('Titanic Buff Tiger', '71901668649846'  , 'Titanic', T, 17677820876),
  makePet('Titanic Inferno Dominus', '133194662787359' , 'Titanic', T, 17265587382),
  makePet('Titanic Party Tiger', '82287378572114'  , 'Titanic', T, 11367696020),
  makePet('Titanic Luchador Cat', '105152814776651' , 'Titanic', T, 16668742321),
  makePet('Titanic Fossil Dragon', '107708637818615' , 'Titanic', T, 16533153490),
  makePet('Titanic Ancient Dragon', '83209252945464'  , 'Titanic', T, 16610737115),
  makePet('Titanic Kitsune Fox', '18352469980'     , 'Titanic', T, 16562371135),
  makePet('Titanic Wicked Angelus', '139550015983813' , 'Titanic', T, 16723429374),
  makePet('Titanic Classic Cat', '18883420114'     , 'Titanic', T, 15693434013),
  makePet('Titanic Super Corgi', '83701890267359'    , 'Titanic', T, 15634372231),
  makePet('Titanic Googly Blobfish', '110994339382883' , 'Titanic', T, 15564383873),
  makePet('Titanic Giraffe', '82353035401807'  , 'Titanic', T, 15412480587),
  makePet('Titanic Electric Werewolf', '76655518621406'  , 'Titanic', T, 15352573160),
  makePet('Titanic Witch Wolf', '74523750699706'  , 'Titanic', T, 15203668680),
  makePet('Titanic Party Crown Hippomelon', '119580032207661' , 'Titanic', T, 14057493999),
  makePet('Titanic Warrior Beast', '131949076812775' , 'Titanic', T, 14800098678),
  makePet('Titanic Sock Cat', '16393837325'     , 'Titanic', T, 14780611537),
  makePet('Titanic Diamond Dog', '95245493036006'  , 'Titanic', T, 14667729845),
  makePet('Titanic Hypnotic Monkey', '85590653495391'  , 'Titanic', T, 14703989238),
  makePet('Titanic Dragonfruit Dragon', '17269789414'     , 'Titanic', T, 14464968364),
  makePet('Titanic Patchwork Capybara', '94494477823308'  , 'Titanic', T, 14169262906),
  makePet('Titanic Jelly Kitsune', '80481264507529'  , 'Titanic', T, 14177106482),
  makePet('Titanic Dino Cat', '14976604955'     , 'Titanic', T, 14132727328),
  makePet('Titanic Scary Corgi', '14976669980'     , 'Titanic', T, 13885953785),
  makePet('Titanic Stunt Cat', '128964854488748' , 'Titanic', T, 13845702877),
  makePet('Titanic Wild Fire Agony', '80761300754593'  , 'Titanic', T, 14055014372),
  makePet('Titanic Empyrean Owl', '104879205036593' , 'Titanic', T, 13675080185),
  makePet('Titanic Holiday Owl', '116557921050130' , 'Titanic', T, 13543603194),
  makePet('Titanic Pink Kitsune Fox', '81549697873082'  , 'Titanic', T, 13462945719),
  makePet('Titanic Gamer Shiba', '119206417994536' , 'Titanic', T, 13563514709),
  makePet('Titanic Party Cat', '16901676187'     , 'Titanic', T, 13512407401),
  makePet('Titanic Calico Cat', '89706854037994'  , 'Titanic', T, 13461954050),
  makePet('Titanic Aura Kitsune', '80758347451953'  , 'Titanic', T, 13670330356),
  makePet('Titanic Sock Monkey', '16393836771'     , 'Titanic', T, 13172797318),
  makePet('Titanic Snowflake Angelus', '72623839017294'  , 'Titanic', T, 12782283567),
  makePet('Titanic Party Panda', '74514642411800'  , 'Titanic', T, 13133928930),
  makePet('Titanic Lucky Cat', '74474705951113'  , 'Titanic', T, 12349558160),
  makePet('Titanic Mosaic Cat', '121979531633033' , 'Titanic', T, 12875689156),
  makePet('Titanic Love Corgi', '124293758484647' , 'Titanic', T, 13114244770),
  makePet('Titanic Orange Axolotl', '17269848594'     , 'Titanic', T, 12780125743),
  makePet('Titanic DJ Shark', '111270922153333' , 'Titanic', T, 12572264176),
  makePet('Titanic Red Panda', '15842479817'     , 'Titanic', T, 12609567785),
  makePet('Titanic Shiba', '16393850015'     , 'Titanic', T, 12647570480),
  makePet('Titanic Matryoshka Cat', '113135543154400' , 'Titanic', T, 12377402962),
  makePet('Titanic Bobcat', '93912731395332'  , 'Titanic', T, 12019774344),
  makePet('Titanic Obsidian Dragon', '98113510502520'  , 'Titanic', T, 12153042678),
  makePet('Titanic Strawberry Corgi', '17269911360'     , 'Titanic', T, 12097679568),
  makePet('Titanic Nyan Cat', '102693200913432' , 'Titanic', T, 11993238002),
  makePet('Titanic Frontman Jellyfish', '91877971354703'  , 'Titanic', T, 11943503631),
  makePet('Titanic Monkey', '15842479997'     , 'Titanic', T, 11766566865),
  makePet('Titanic Koi Fish', '86724162375646'  , 'Titanic', T, 11619874571),
  makePet('Titanic Wood Spirit', '125083583849659' , 'Titanic', T, 11428990844),
  makePet('Titanic Parrot', '81714067299017'  , 'Titanic', T, 11518716945),
  makePet('Titanic Axolotl', '14976585715'     , 'Titanic', T, 11371953403),
  makePet('Titanic Gingerbread Dragon', '110203202746890' , 'Titanic', T, 11167639712),
  makePet('Titanic Super Coral Stingray', '78134385272600'  , 'Titanic', T, 11225516607),
  makePet('Titanic Black Hole Angelus Ball', '113303682260217' , 'Titanic', T, 11144038928),
  makePet('Titanic Snowflake Dominus', '71393734598151'  , 'Titanic', T, 11051593554),
  makePet('Titanic Jurassic Feline', '129218443079434' , 'Titanic', T, 10706432569),
  makePet('Titanic Guard Dominus', '100676807930076' , 'Titanic', T, 10743936909),
  makePet('Titanic Dolphin', '17269957040'     , 'Titanic', T, 10575032050),
  makePet('Titanic Cupcake Pegasus', '78403514636510'  , 'Titanic', T, 10555078511),
  makePet('Titanic Arcane Halo Cat', '94452581960646'  , 'Titanic', T, 7503065580),
  makePet('Titanic Nightmare Sludge', '92769377018385'  , 'Titanic', T, 10468246601),
  makePet('Titanic Grinch Cat', '105600589075929' , 'Titanic', T, 10554704391),
  makePet('Titanic Crocodilo Brainrot', '134789752916568' , 'Titanic', T, 10328859767),
  makePet('Titanic Reindeer', '15581758974'     , 'Titanic', T, 10339840984),
  makePet('Titanic Cheerful Yeti', '14976595593'     , 'Titanic', T, 10241358582),
  makePet('Titanic Propeller Cat', '73254502740127'  , 'Titanic', T, 10192899718),
  makePet('Titanic Fawn', '14976619071'     , 'Titanic', T, 10260414165),
  makePet('Titanic Gingerbread Cat', '123881708128597' , 'Titanic', T, 10073774655),
  makePet('Titanic Noob', '101954252153126' , 'Titanic', T, 10761090217),
  makePet('Titanic Pineapple Cat', '17269938973'     , 'Titanic', T, 9892686922),
  makePet('Titanic Totem Owl', '113883294151672' , 'Titanic', T, 9838770777),
  makePet('Titanic Arcane Void Cat', '77026614501642'  , 'Titanic', T, 8731601417),
  makePet('Titanic Blobenstein', '133816643880772'   , 'Titanic', T, 9511289497),
  makePet('Titanic Valentines Axolotl'          , '123399141850216' , 'Titanic', T, 9330236039),
  makePet('Titanic Glass Blobfish', '95794427114818'  , 'Titanic', T, 8891775045),
  makePet('Titanic Wishing Dragon', '133278674561506' , 'Titanic', T, 9064763895),
  makePet('Titanic Scroll Dragon', '118843935500036' , 'Titanic', T, 8528598398),
  makePet('Titanic Leprechaun Kitsune', '119959214731762' , 'Titanic', T, 8729337705),
  makePet('Titanic Leafy Seahorse', '116393400860813'   , 'Titanic', T, 8684619921),
  makePet('Titanic Chest Mimic', '121868378193136'   , 'Titanic', T, 8629131517),
  makePet('Titanic Gingerbread Corgi', '14976625491'       , 'Titanic', T, 8576595203),
  makePet('Titanic Doll Cat', '93143962349458'  , 'Titanic', T, 8559921853),
  makePet('Titanic Mechanical Griffin', '139823159544156' , 'Titanic', T, 8421476320),
  makePet('Titanic Dark Fox', '110119044336998' , 'Titanic', T, 8487051794),
  makePet('Titanic Abyss Carbuncle', '121024391063626' , 'Titanic', T, 8299404881),
  makePet('Titanic Loveserker', '134671434987896' , 'Titanic', T, 8358670305),
  makePet('Titanic Reindeer Cat', '119319411340325' , 'Titanic', T, 8231150402),
  makePet('Titanic Autumn Teddy Bear', '102130006064216'   , 'Titanic', T, 8204281508),
  makePet('Titanic Clover Butterfly', '131125477985744' , 'Titanic', T, 8134004508),
  makePet('Titanic Lucki Angelus', '140159437559092' , 'Titanic', T, 8075851878),
  makePet('Titanic Pixel Angelus', '103752775543007' , 'Titanic', T, 7939528855),
  makePet('Titanic Icy Phoenix', '119756929621348' , 'Titanic', T, 8007318863),
  makePet('Titanic Easter Cat', '122516564229104' , 'Titanic', T, 7752891920),
  makePet('Titanic Sun Griffin', '131108865732967' , 'Titanic', T, 7779976593),
  makePet('Titanic Jelly Wizard', '125800512820483' , 'Titanic', T, 7809492738),
  makePet('Titanic Origami Crane', '77309638284981'  , 'Titanic', T, 7455873438),
  makePet('Titanic Disco Ball Agony', '79337032741269'  , 'Titanic', T, 7705276097),
  makePet('Titanic Easter Golem', '109664286681118' , 'Titanic', T, 7706612750),
  makePet('Titanic Kraken', '82337742221537'  , 'Titanic', T, 7717340393),
  makePet('Titanic Party Corgi', '122915996316714' , 'Titanic', T, 7650857729),
  makePet('Titanic Keyboard Cat', '138627945084194' , 'Titanic', T, 7674108647),
  makePet('Titanic Beach Ball Capybara', '75537750566110'  , 'Titanic', T, 7478107425),
  makePet('Titanic Pixel Agony', '79227180725829'  , 'Titanic', T, 7522789709),
  makePet('Titanic Captain Octopus', '108839170452682' , 'Titanic', T, 7526386857),
  makePet('Titanic Party Crown Corgi', '127025398818263' , 'Titanic', T, 7489187277),
  makePet('Titanic Brain Ball', '85082755103963'  , 'Titanic', T, 7448558656),
  makePet('Titanic Holographic Axolotl Ball', '113783111337082' , 'Titanic', T, 7401874971),
  makePet('Titanic Pixel Monkey', '109746451259530' , 'Titanic', T, 7199806408),
  makePet('Titanic Inferno Cat', '128197933261486' , 'Titanic', T, 6306951957),
  makePet('Titanic Gingerbread Angelus', '135459719245097' , 'Titanic', T, 7030230044),
  makePet('Titanic Nutcracker Squirrel', '72074096332299'  , 'Titanic', T, 7104536823),
  makePet('Titanic Gym Cat', '116586359126755' , 'Titanic', T, 7104468875),
  makePet('Titanic Gym Dragon', '91679016973225'  , 'Titanic', T, 6973811891),
  makePet('Titanic Gym Axolotl', '105883777354766' , 'Titanic', T, 6955409872),
  makePet('Titanic Guilded Raven', '133529343440925' , 'Titanic', T, 6758649384),
  makePet('Titanic Super Wolf', '114045876201670' , 'Titanic', T, 6887361279),
  makePet('Titanic Lucki Golem', '136718232635599' , 'Titanic', T, 6789246286),
  makePet('Titanic Candycane Kitsune', '100308163043577' , 'Titanic', T, 6765712145),
  makePet('Titanic Yee-haw Cat', '111695166466582' , 'Titanic', T, 6687412308),
  makePet('Titanic Anime Cat', '139657034071879' , 'Titanic', T, 6638970255),
  makePet('Titanic Pilgrim Turkey', '126580879775166' , 'Titanic', T, 6606472146),
  makePet('Titanic Diamond Bunny', '118509963937429' , 'Titanic', T, 6513107217),
  makePet('Titanic Treasure Mimic', '101381725674777' , 'Titanic', T, 6523009150),
  makePet('Titanic Special Ops Goat', '113002170903758' , 'Titanic', T, 6504129521),
  makePet('Titanic Gym Piggy', '83418426138856'  , 'Titanic', T, 6669960914),
  makePet('Titanic Teacher Cat', '104387672853610'   , 'Titanic', T, 6544814312),
  makePet('Titanic Hydra Axolotl', '116530316117361' , 'Titanic', T, 6520643137),
  makePet('Titanic Comet Cyclops Ball', '83088944433726'  , 'Titanic', T, 6298833571),
  makePet('Titanic Gym Shark', '116575608018506' , 'Titanic', T, 6363733358),
  makePet('Titanic Sandcastle Kraken', '90627425215733'  , 'Titanic', T, 6396606082),
  makePet('Titanic Pixel Dominus Astra', '129315342087717' , 'Titanic', T, 6478090176),
  makePet('Titanic Ooze Cat', '114761957372566' , 'Titanic', T, 6402045895),
  makePet('Titanic Easter Axolotl', '76996694412887'  , 'Titanic', T, 6338778298),
  makePet('Titanic Helicopter Corgi', '139030108461655' , 'Titanic', T, 6330968107),
  makePet('Titanic Spirit Mushroom', '86911408081625'  , 'Titanic', T, 6263307641),
  makePet('Titanic Basketball Cat', '88337098275915'  , 'Titanic', T, 6296054857),
  makePet('Titanic Narwhal', '100083536961839' , 'Titanic', T, 6189719511),
  makePet('Titanic Night Terror Dog', '112505092769187' , 'Titanic', T, 6260101352),
  makePet('Titanic Gym Unicorn', '86624734020676'  , 'Titanic', T, 6109235423),
  makePet('Titanic Storm Axolotl Ball', '140349148341918' , 'Titanic', T, 6039475773),
  makePet('Titanic Diamond Monkey', '77972912232748'  , 'Titanic', T, 6047864971),
  makePet('Titanic Ice Snake', '136281455287593' , 'Titanic', T, 6063531094),
  makePet('Titanic Nutcracker Cat', '131594588116580' , 'Titanic', T, 6011191315),
  makePet('Titanic Nuclear Dominus', '89079914653580'  , 'Titanic', T, 5674544473),
  makePet('Titanic Snow Elf', '137871430705388' , 'Titanic', T, 5980910101),
  makePet('Titanic Leprechaun Dog', '82186253097928'  , 'Titanic', T, 5940273610),
  makePet('Titanic Crackling Dragon', '83961459866368'  , 'Titanic', T, 5843398165),
  makePet('Titanic Prickly Panda', '110590155279741' , 'Titanic', T, 5309734546),
  makePet('Titanic Snow Globe Snowman', '78333791441483'  , 'Titanic', T, 5927840808),
  makePet('Titanic Glitched Cat Ball', '106995873715009' , 'Titanic', T, 5863250220),
  makePet('Titanic Exquisite Cat', '71126391222560'  , 'Titanic', T, 5713537059),
  makePet('Titanic Chesnut Chipmunk', '106520142192819' , 'Titanic', T, 5571721534),
  makePet('Titanic Surfboard Corgi', '94523830121587'  , 'Titanic', T, 5525319318),
  makePet('Titanic Owl', '111258824225580' , 'Titanic', T, 5487341372),
  makePet('Titanic Withered Agony', '131171482429329' , 'Titanic', T, 5419800288),
  makePet('Titanic Red Dragon', '102919400453870' , 'Titanic', T, 5360487421),
  makePet('Titanic Sea Dragon', '97419954429083'  , 'Titanic', T, 5400180105),
  makePet('Titanic North Pole Unicorn', '127223502497366' , 'Titanic', T, 5314678490),
  makePet('Titanic Hippomint', '118720066911760' , 'Titanic', T, 5251260058),
  makePet('Titanic Pineapple Dog', '99869089555079'  , 'Titanic', T, 5310661147),
  makePet('Titanic Old Wizard Cat', '85718953892638'  , 'Titanic', T, 5350898245),
  makePet('Titanic Persimmony Cricket', '107901135144472' , 'Titanic', T, 5175330717),
  makePet('Titanic Exquisite Elephant', '97422903795997'  , 'Titanic', T, 5143503986),
  makePet('Titanic Pumpkin Dog', '92147535439252'  , 'Titanic', T, 5188573929),
  makePet('Titanic Devil Tasmanian', '90163785900987'  , 'Titanic', T, 5136473178),
  makePet('Titanic Ghost Axolotl', '81649535142902'  , 'Titanic', T, 5065131325),
  makePet('Titanic Pink Lucky Block', '106313575575295' , 'Titanic', T, 5034862500),
  makePet('Titanic Specter Owl', '75229651213956'  , 'Titanic', T, 5092636896),
  makePet('Titanic Ghostly Wolf', '122682792759281' , 'Titanic', T, 4929534432),
  makePet('Titanic Veil Horse', '80965165352380'  , 'Titanic', T, 4890003431),
  makePet('Titanic Ruinous Angelus', '128700972772946' , 'Titanic', T, 4914400834),
  makePet('Titanic Scribe Squirrel', '119222051257563' , 'Titanic', T, 4909089487),
  makePet('Titanic Irish Badger', '94461290807119'  , 'Titanic', T, 4967773359),
  makePet('Titanic Lucki Chest Mimic', '96487317914550'  , 'Titanic', T, 4958961377),
  makePet('Titanic Starlight Pony', '130735528136584' , 'Titanic', T, 4989328265),
  makePet('Titanic Tiedye Corgi', '116762893028421' , 'Titanic', T, 4942506139),
  makePet('Titanic Diamond Chick', '136894452978816' , 'Titanic', T, 4835641227),
  makePet('Titanic Mucki', '90224746206001'  , 'Titanic', T, 4824427390),
  makePet('Titanic Butterfly Pony', '71576208236179'  , 'Titanic', T, 4848966253),
  makePet('Titanic Werewolf', '111055741189811' , 'Titanic', T, 4765057337),
  makePet('Titanic Quokka', '118478723717753' , 'Titanic', T, 4830245553),
  makePet('Titanic Garden Goblin', '88678695683652'  , 'Titanic', T, 4804319569),
  makePet('Titanic Horseshoe Capybara', '123799433533609' , 'Titanic', T, 4802304235),
  makePet('Titanic Irish Wolfhound', '125815340060379' , 'Titanic', T, 4747244755),
...
/* -- HUGE -- (926 pets, real RAP from db.biggames.io) */
  ...
  makePet('Huge Demon', '92733626673208', 'Huge', H, 29078000000),
  makePet('Huge Holographic Corgi', '117552656030475', 'Huge', H, 25400000000),
  makePet('Huge Present Cat', '15637230004', 'Huge', H, 24686318454),
  makePet('Huge Splash Angelus', '70796008015802', 'Huge', H, 22623514977),
  makePet('Huge Crowned Dog', '116949971917880', 'Huge', H, 23157500851),
  makePet('Huge Wisp Deer', '119889276435598', 'Huge', H, 20094652196),
  makePet('Huge Cat', '14976374906', 'Huge', H, 17755532616),
  makePet('Huge Stunt Unicorn', '14976564045', 'Huge', H, 18087032394),
  makePet('Huge Alien Arachnid', '16756608144', 'Huge', H, 17763125412),
  makePet('Huge Runic Wolf', '90992015930571', 'Huge', H, 15387040000),
  makePet('Huge Sensei Penguin', '16029125715', 'Huge', H, 12541318204),
  makePet('Huge Blue Balloon Cat', '14976365873', 'Huge', H, 12422959223),
  makePet('Huge Bubble Dog', '17277934726', 'Huge', H, 11727530183),
  makePet('Huge Angelus', '14976350830', 'Huge', H, 11179599835),
  makePet('Huge Pixel Shark', '17024845317', 'Huge', H, 9984743909),
  makePet('Huge Bread Shiba', '14976370557', 'Huge', H, 9728305349),
  makePet('Huge White Balloon Cat', '14976576332', 'Huge', H, 5502047865),
  makePet('Huge Mystical Fox', '14976496299', 'Huge', H, 6334473235),
  makePet('Huge Butterfly', '14976372228', 'Huge', H, 9300975312),
  makePet('Huge Hoverboard Dog', '117980545661053', 'Huge', H, 5790481711),
  makePet('Huge Mummy Bunny', '101133530585577', 'Huge', H, 4951006897),
  makePet('Huge Storm Agony', '15260479669', 'Huge', H, 4304214372),
  makePet('Huge Ninja Capybara', '101889999202642', 'Huge', H, 4303554403),
  makePet('Huge Anime Agony', '14976351312', 'Huge', H, 4172342349),
  makePet('Huge Inferno Cat', '14976463498', 'Huge', H, 4026211305),
  makePet('Huge Pop Cat', '14976525879', 'Huge', H, 3400567136),
  makePet('Huge Cupcake Unicorn', '14976388989', 'Huge', H, 3764509844),
  ...
  makePet('Huge Neon Twilight Dragon', '15260481819', 'Huge', H, 2997841266),
  makePet('Huge Guard Bunny', '70728047813207', 'Huge', H, 2915886706),
  makePet('Huge Sombrero Chihuahua', '14976553203', 'Huge', H, 2839011137),
  makePet('Huge Prickly Panda', '14976527289', 'Huge', H, 2781490640),
  makePet('Huge Crackling Dragon', '125990599285140', 'Huge', H, 2710896329),
  makePet('Huge Kawaii Cat', '14976470713', 'Huge', H, 2616936792),
  makePet('Huge Principal Anteater', '124723336680703', 'Huge', H, 2651942217),
  makePet('Huge Easter Cat', '15281989384', 'Huge', H, 2603734686),
  makePet('Huge Wyvern of Hades', '113089838370784', 'Huge', H, 2637802869),
  makePet('Huge Santa Paws', '14976542836', 'Huge', H, 2402009240),
  makePet('Huge Comet Agony', '14976384743', 'Huge', H, 2310024925),
  makePet('Huge Cyborg Capybara', '15260482561', 'Huge', H, 2460196082),
  makePet('Huge Frontman Jellyfish', '104443983862799', 'Huge', H, 2396881092),
  makePet('Huge Patrick Star', '18313092558', 'Huge', H, 2362215275),
  makePet('Huge Basketball Retriever', '14976360269', 'Huge', H, 2382794980),
  makePet('Huge Ghost Cat', '94290261080713', 'Huge', H, 2301561051),
  makePet('Huge Angel Cat', '15281990207', 'Huge', H, 2324181772),
  makePet('Huge Diamond Dragon', '135778952005746', 'Huge', H, 2232294756),
  makePet('Huge Lucky Cat', '14976485216', 'Huge', H, 2207131528),
  makePet('Huge Reversed Cat', '86486361253800', 'Huge', H, 2195352341),
  makePet('Huge Diamond Cat', '14976396731', 'Huge', H, 2146705524),
  makePet('Huge Chest Mimic', '14976376935', 'Huge', H, 2203964387),
  makePet('Huge Orange Balloon Cat', '14976505912', 'Huge', H, 2132319654),
  makePet('Huge Glitched Cat', '16468736057', 'Huge', H, 2167027148),
  makePet('Huge Ice Cream Cone', '14976462189', 'Huge', H, 2138780999),
  makePet('Huge Gamer Shiba', '14976439240', 'Huge', H, 2106213485),
  makePet('Huge Forest Wyvern', '14976435839', 'Huge', H, 1949395420),
  makePet('Huge Gingerbread Dragon', '110621195469129', 'Huge', H, 2055212245),
  makePet('Huge Sad Hamster', '139847485438413', 'Huge', H, 2025212145),
  makePet('Huge Clown Cat', '18520054035', 'Huge', H, 2070880703),
  makePet('Huge Dino Cat', '14976397288', 'Huge', H, 1948215007),
  makePet('Huge Grim Reaper', '14976567210', 'Huge', H, 2026596916),
  makePet('Huge Shiba', '14976547077', 'Huge', H, 1997119608),
  makePet('Huge Pufferfish', '14976528215', 'Huge', H, 1916502814),
  makePet('Huge Axolotl', '14976357246', 'Huge', H, 1875898157),
  makePet('Huge Monkey', '14976491927', 'Huge', H, 1840965361),
  makePet('Huge Capybara', '14976373698', 'Huge', H, 1747734536),
  makePet('Huge Santa Monkey', '15281988558', 'Huge', H, 1629181746),
  makePet('Huge Heart Balloon Cat', '16306792637', 'Huge', H, 1569812216),
  makePet('Huge Hedgehog', '76079961004041', 'Huge', H, 1568864782),
  makePet('Huge Pinata Cat', '14976516399', 'Huge', H, 814643542),
  makePet('Huge Evil Deer', '105420679784540', 'Huge', H, 1454909534),
  makePet('Huge Panda', '86383655760798', 'Huge', H, 1426545880),
  makePet('Huge Shark Cat', '96757523363685', 'Huge', H, 1426281721),
  makePet('Huge Gargoyle Dragon', '14976439876', 'Huge', H, 1232517459),
  makePet('Huge Apple Capybara', '14976352410', 'Huge', H, 1389361383),
  makePet('Huge Hubert', '140721677142555', 'Huge', H, 1337743776),
  makePet('Huge Love Lamb', '14976476986', 'Huge', H, 1334204080),
  makePet('Huge Sleipnir', '15260480028', 'Huge', H, 1287529289),
  makePet('Huge Fragmented Dominus', '17421845704', 'Huge', H, 1386210630),
  makePet('Huge Balloon Cat', '14976358748', 'Huge', H, 1210045341),
  makePet('Huge Cow', '14976386456', 'Huge', H, 1190952149),
  makePet('Huge Rave Crab', '109133967059639', 'Huge', H, 1138842174),
  makePet('Huge Blurred Agony', '136961969731573', 'Huge', H, 1130494114),
  makePet('Huge Otter', '14976506594', 'Huge', H, 1202299145),
  makePet('Huge Green Balloon Cat', '14976447015', 'Huge', H, 1098368730),
  makePet('Huge Three Headed Dragon', '14976567497', 'Huge', H, 1085724544),
  makePet('Huge Atlantean Dolphin', '14976354622', 'Huge', H, 1038590218),
  makePet('Huge Hippomelon', '14976456685', 'Huge', H, 1037896139),
  makePet('Huge Mr Krabs', '18313092725', 'Huge', H, 1075262108),
  makePet('Huge Clover Dragon', '14976383366', 'Huge', H, 1002350758),
  makePet('Huge Mushroom King', '125986697104431', 'Huge', H, 1047602445),
  makePet('Huge Tiedye Dog', '117016363569133', 'Huge', H, 977964879),
  makePet('Huge M-10 PROTOTYPE', '15260482198', 'Huge', H, 898994236),
  makePet('Huge Safari Dog', '14976538804', 'Huge', H, 929861313),
  makePet('Huge Dog', '14976397743', 'Huge', H, 929445554),
  makePet('Huge Kraken', '14976473284', 'Huge', H, 896800734),
  makePet('Huge Lit Octopus', '100395307748648', 'Huge', H, 864719922),
  makePet('Huge Poseidon Axolotl', '86210025446242', 'Huge', H, 901311262),
  makePet('Huge Lucki Dominus', '78303914095670', 'Huge', H, 901502822),
  makePet('Huge Neon Griffin', '14976498238', 'Huge', H, 876846838),
  makePet('Huge Ducky', '14976415577', 'Huge', H, 874371101),
  makePet('Huge Balloon Corgi', '135934944336063', 'Huge', H, 884380747),
  makePet('Huge Puurple Cat', '17450362839', 'Huge', H, 883776523),
  makePet('Huge Reindeer Dog', '15281988831', 'Huge', H, 876526477),
  makePet('Huge Safety Cat', '18127300990', 'Huge', H, 873121851),
  makePet('Huge Lucki', '14976484952', 'Huge', H, 844367584),
  makePet('Huge Anime Unicorn', '14976352077', 'Huge', H, 842048250),
  makePet('Huge Reindeer Axolotl', '15281989034', 'Huge', H, 857708077),
  makePet('Huge Party Monkey', '14976510684', 'Huge', H, 865719660),
  makePet('Huge Blimp Dragon', '113409897234634', 'Huge', H, 858537516),
  makePet('Huge Corgi', '14976386115', 'Huge', H, 819572848),
  makePet('Huge Pink Marshmallow Chick', '14976517974', 'Huge', H, 821309331),
  makePet('Huge Balloon Axolotl', '14976358125', 'Huge', H, 793380121),
  makePet('Huge Tiki Dominus', '14976571122', 'Huge', H, 793686903),
  makePet('Huge Holographic Monkey', '77505723512124', 'Huge', H, 789048972),
  makePet('Huge Santa Dragon', '15281988711', 'Huge', H, 776624782),
  makePet('Huge Pixel Wolf', '14976522632', 'Huge', H, 766020463),
  makePet('Huge Pony', '14976525582', 'Huge', H, 765634514),
  makePet('Huge Present Chest Mimic', '14976527111', 'Huge', H, 763153250),
  makePet('Huge Nightmare Kraken', '14976502236', 'Huge', H, 730225710),
  makePet('Huge Snowman', '15199736050', 'Huge', H, 752109881),
  makePet('Huge Sphinx', '112960031922397', 'Huge', H, 780882752),
  makePet('Huge Dominus Lucki', '14976479237', 'Huge', H, 743424663),
  makePet('Huge Dragon', '14976414803', 'Huge', H, 750585764),
  makePet('Huge Black Hole Kitsune', '17285736637', 'Huge', H, 767328914),
  makePet('Huge Balloon Dragon', '14976359350', 'Huge', H, 746604803),
  makePet('Huge Pumpkin Cat', '14976529226', 'Huge', H, 744925456),
  makePet('Huge Hoverboard Cat', '15542598827', 'Huge', H, 730447996),
  makePet('Huge Hacked Cat', '14976449581', 'Huge', H, 719765096),
  makePet('Huge Reaper Cat', '136851484598871', 'Huge', H, 741439655),
  makePet('Huge Grinch Cat', '14976448309', 'Huge', H, 719357317),
  makePet('Huge Atlantean Orca', '14976355521', 'Huge', H, 716038430),
  makePet('Huge Pog Cat', '123648690581827', 'Huge', H, 703916661),
  makePet('Huge Sandcastle Cat', '14976541813', 'Huge', H, 712124000),
  makePet('Huge Bloo Cat', '17375064407', 'Huge', H, 677099314),
  makePet('Huge Super Corgi', '14976565468', 'Huge', H, 696778576),
  makePet('Huge Rainbow Unicorn', '14976532168', 'Huge', H, 681271474),
  makePet('Huge Valentines Cat', '16290990548', 'Huge', H, 686149742),
  makePet('Huge Floppa', '14976434470', 'Huge', H, 647997016),
  makePet('Huge Amethyst Dragon', '14976350251', 'Huge', H, 646839757),
  makePet('Huge Lucki Agony', '14976478543', 'Huge', H, 651612829),
  makePet('Huge Evolved Hacked Cat', '14976425579', 'Huge', H, 644217676),
  makePet('Huge Specter Owl', '96339575163664', 'Huge', H, 673709143),
  makePet('Huge Nightfall Pegasus', '15260481050', 'Huge', H, 643250879),
  makePet('Huge Neon Twilight Wolf', '15260481429', 'Huge', H, 661965408),
  makePet('Huge Mummy Cow', '98874916712415', 'Huge', H, 654718911),
  makePet('Huge Inferno Dominus', '14976463903', 'Huge', H, 630020784),
  makePet('Huge Doodle Agony', '117441180861427', 'Huge', H, 648075209),
  makePet('Huge Junkyard Hound', '82197525577335', 'Huge', H, 623669863),
  makePet('Huge Cool Cat', '14976385467', 'Huge', H, 609709432),
  makePet('Huge Sapphire Phoenix', '15260480400', 'Huge', H, 616093184),
  makePet('Huge Evolved Pixel Cat', '14976426599', 'Huge', H, 615035269),
  makePet('Huge Pixel Chick', '109348174675332', 'Huge', H, 607627176),
  makePet('Huge Nightmare Cyclops', '98277417659107', 'Huge', H, 603704944),
  makePet('Huge Scuba Dog', '139017924153372', 'Huge', H, 599957734),
  makePet('Huge Emoji Monkey', '16047450351', 'Huge', H, 579786078),
  makePet('Huge Festive Cat', '15281989250', 'Huge', H, 593959470),
  makePet('Huge Dominus Darkwing', '100391666936804', 'Huge', H, 601460078),
  makePet('Huge Vampire Agony', '130091557043756', 'Huge', H, 584895117),
  makePet('Huge Wild Fire Agony', '14976578547', 'Huge', H, 566378045),
  makePet('Huge Sad Doge', '126938121450876', 'Huge', H, 569391696),
  makePet('Huge Sun Angelus', '14976564553', 'Huge', H, 554379356),
  makePet('Huge Arcade Cat', '14976352617', 'Huge', H, 557691647),
  makePet('Huge Firefly', '16744676508', 'Huge', H, 556004050),
  makePet('Huge Hologram Axolotl', '14976456919', 'Huge', H, 553858911),
  makePet('Huge Brain', '88763930700070', 'Huge', H, 536025957),
  makePet('Huge Nightfall Wolf', '15260480737', 'Huge', H, 539579736),
  makePet('Huge Pastel Sock Dragon', '14976513814', 'Huge', H, 539456995),
  makePet('Huge Hot Dog', '16250978135', 'Huge', H, 512632061),
  makePet('Huge Husky', '14976460483', 'Huge', H, 510827892),
  makePet('Huge UV Kitsune Ball', '133144353929951', 'Huge', H, 517092362),
  makePet('Huge Hacked Skeleton', '134082855413685', 'Huge', H, 500805429),
  makePet('Huge Nyan Cat', '111205928887511', 'Huge', H, 516194864),
  makePet('Huge Doodle Bee', '84450044658879', 'Huge', H, 475165729),
  makePet('Huge White Tiger', '14976576861', 'Huge', H, 479310816),
  makePet('Huge Celestial Dragon', '15163489240', 'Huge', H, 466800670),
  makePet('Huge Pixel Agony', '85105390467566', 'Huge', H, 474812772),
  makePet('Huge Neon Cat', '14976497661', 'Huge', H, 433775227),
  makePet('Huge 404 Demon', '17288680692', 'Huge', H, 415517988),
  makePet('Huge Peppermint Angelus', '15716049163', 'Huge', H, 454259878),
  makePet('Huge Autumn Chest Mimic', '131920407611756', 'Huge', H, 451560358),
  makePet('Huge Shadow Griffin', '14976546605', 'Huge', H, 445289621),
  makePet('Huge Arcane Dominus', '84981023975118', 'Huge', H, 455803511),
  makePet('Huge Athena Owl', '117588896362117', 'Huge', H, 446051201),
  makePet('Huge Storm Dominus', '15260478906', 'Huge', H, 435030509),
  makePet('Huge Googly Shark', '103658339806343', 'Huge', H, 462729653),
  makePet('Huge Super Tiger', '16746767650', 'Huge', H, 428761608),
  makePet('Huge BIG Maskot', '14976363084', 'Huge', H, 441269536),
  makePet('Huge Knife Cat', '14976472648', 'Huge', H, 444528427),
  makePet('Huge Pixel Sad Cat', '132317712200378', 'Huge', H, 440459633),
  makePet('Huge Valentines Angelus', '74709418271997', 'Huge', H, 426104213),
  makePet('Huge Gleebo The Alien', '14976443059', 'Huge', H, 422389176),
  makePet('Huge Forged Robot', '136825338355926', 'Huge', H, 432623042),
  makePet('Huge Evolved Cupcake', '14976425356', 'Huge', H, 427358265),
  makePet('Huge Party Penguin', '14976511281', 'Huge', H, 430894506),
  makePet('Huge Matryoshka Capybara', '135978924000516', 'Huge', H, 428285638),
  makePet('Huge Matryoshka Dino', '130741332412242', 'Huge', H, 414924503),
  makePet('Huge Ghoul Horse', '138823579638125', 'Huge', H, 407823016),
  makePet('Huge Mrs. Claws', '14976494867', 'Huge', H, 406836590),
  makePet('Huge Samurai Dragon', '14976541241', 'Huge', H, 419975810),
  makePet('Huge Jelly Butterfly', '119227116644693', 'Huge', H, 404570436),
  makePet('Huge Claw Beast', '102986417616097', 'Huge', H, 410170377),
  makePet('Huge Shark', '14976546876', 'Huge', H, 402551886),
  makePet('Huge Safari Cat', '14976538607', 'Huge', H, 383828756),
  makePet('Huge Machete Dog', '108025600456665', 'Huge', H, 402918245),
  makePet('Huge Comet Cyclops', '14976385072', 'Huge', H, 386727585),
  makePet('Huge Ninja Axolotl', '14976503103', 'Huge', H, 380098619),
  makePet('Huge Hypnotic Dragon', '90381015332493', 'Huge', H, 386604938),
  makePet('Huge Cupcake', '14976389145', 'Huge', H, 373568320),
  makePet('Huge Dot Matrix Axolotl', '121462024507634', 'Huge', H, 385340578),
  makePet('Huge Wild Corrupt Agony', '83829095123136', 'Huge', H, 375271163),
  makePet('Huge Snow Globe Hamster', '83324398369784', 'Huge', H, 369984873),
  makePet('Huge Techno Cat', '14976566707', 'Huge', H, 377130044),
  makePet('Huge Party Cat', '14976508941', 'Huge', H, 373803505),
  makePet('Huge Wicked Angelus', '87751794177322', 'Huge', H, 343675557),
  makePet('Huge Strawberry Cow', '14976561960', 'Huge', H, 352037771),
  makePet('Huge Cyborg Cat', '14976391620', 'Huge', H, 358067422),
  makePet('Huge Vampire Dragon', '122834900117274', 'Huge', H, 357585329),
  makePet('Huge Nice Cat', '135884487799308', 'Huge', H, 363293160),
  makePet('Huge Cartoon Demon', '114799627163759', 'Huge', H, 354970140),
  makePet('Huge Corn Cat', '115417271549195', 'Huge', H, 351023284),
  makePet('Huge Chad Bunny', '106226869216523', 'Huge', H, 348422346),
  makePet('Huge Valkyrie Wolf', '18465100470', 'Huge', H, 340530543),
  makePet('Huge Sailor Shark', '14976540139', 'Huge', H, 346885345),
  makePet('Huge Tech Samurai Cat', '17028331108', 'Huge', H, 335740400),
  makePet('Huge Kaiju Hydra', '104819925091161', 'Huge', H, 344361994),
  makePet('Huge Matrix Monkey', '17861579273', 'Huge', H, 323230515),
  makePet('Huge Pixel Cat', '14976519049', 'Huge', H, 328781026),
  makePet('Huge Poison Turtle', '90099723016359', 'Huge', H, 318040187),
  makePet('Huge Soul Dragon', '95241548572659', 'Huge', H, 310898292),
  makePet('Huge Bear', '14976361884', 'Huge', H, 310141615),
  makePet('Huge Stacked Dominus', '96928518190910', 'Huge', H, 308676379),
  makePet('Huge Tralala Brainrot', '130205496743645', 'Huge', H, 307183898),
  makePet('Huge Pixel Capybara', '120551262539366', 'Huge', H, 308671186),
  makePet('Huge Fragmented Golem', '104056264494147', 'Huge', H, 307710072),
  makePet('Huge Pixel M-2 PROTOTYPE', '114437689272259', 'Huge', H, 293337436),
  makePet('Huge Phantom Wolf', '73617612474545', 'Huge', H, 307339161),
  makePet('Huge Baby Piglet', '115008493887428', 'Huge', H, 306684371),
  makePet('Huge Sun Griffin', '122831150159277', 'Huge', H, 302792504),
  makePet('Huge Rich Corgi', '124517901804987', 'Huge', H, 296972738),
  makePet('Huge Firefighter Dalmation', '14976432950', 'Huge', H, 197420699),
  makePet('Huge Little Melty', '125054778559458', 'Huge', H, 297206105),
  makePet('Huge Snow Globe Corgi', '77464634142348', 'Huge', H, 289571003),
  makePet('Huge Good vs Evil Dragon', '18256895106', 'Huge', H, 287949694),
  makePet('Huge Wireframe Cat', '129889522181856', 'Huge', H, 213003644),
  makePet('Huge Hologram Shark', '14976457374', 'Huge', H, 287619917),
  makePet('Huge Abstract Agony', '121388356688777', 'Huge', H, 279337355),
  makePet('Huge Forcefield Cat', '85865166902992', 'Huge', H, 277232649),
  makePet('Huge Baby Puppy', '133001320495204', 'Huge', H, 291479434),
  makePet('Huge Midnight Axolotl', '124395858788677', 'Huge', H, 280801804),
  makePet('Huge Party Dog', '14976510103', 'Huge', H, 274769945),
  makePet('Huge Aura Dominus', '96765579469696', 'Huge', H, 276724478),
  makePet('Huge Party Crown Ducky', '14976509521', 'Huge', H, 272544245),
  makePet('Huge Jelly Hydra', '109899952808122', 'Huge', H, 270576906),
  makePet('Huge Redstone Cat', '14976533671', 'Huge', H, 264720742),
  makePet('Huge Unicorn', '14976573179', 'Huge', H, 263951613),
  makePet('Huge Fairy', '14976428656', 'Huge', H, 259677860),
  makePet('Huge Doodle Cat', '14976402524', 'Huge', H, 263475931),
  makePet('Huge Zeus Bear', '112711947085113', 'Huge', H, 260304901),
  makePet('Huge Orca', '14976506366', 'Huge', H, 247818406),
  makePet('Huge Nightmare Spirit', '14976825431', 'Huge', H, 244545418),
  makePet('Huge Sketch Dragon', '17027110585', 'Huge', H, 258840014),
  makePet('Huge Blazing Bat', '17749191682', 'Huge', H, 245522590),
  makePet('Huge Midnight Cat', '137864465151841', 'Huge', H, 245316707),
  makePet('Huge Keyboard Cat', '135774541851149', 'Huge', H, 241073560),
  makePet('Huge Quantum Agony', '18886114160', 'Huge', H, 228918691),
  makePet('Huge Storm Axolotl', '136706503808298', 'Huge', H, 227803252),
  makePet('Huge Easter Yeti', '14976418843', 'Huge', H, 229607806),
  makePet('Huge Cartoon Bunny', '83751288485339', 'Huge', H, 234544582),
  makePet('Huge Lucki Chest Mimic', '76209866418616', 'Huge', H, 222553829),
  makePet('Huge Silver Bison', '84066657205534', 'Huge', H, 224026791),
  makePet('Huge Sun Agony', '17687869169', 'Huge', H, 225016689),
  makePet('Huge Clover Owl', '138442898804320', 'Huge', H, 215382930),
  makePet('Huge Fox', '14976436421', 'Huge', H, 223506745),
  makePet('Huge Black Hole Axolotl', '17285736425', 'Huge', H, 214878183),
  makePet('Huge Leprechaun Dog', '82125738012621', 'Huge', H, 216620601),
  makePet('Huge Super Coral Hydra', '70870472183962', 'Huge', H, 205736090),
  makePet('Huge Lit Loris', '132382180739478', 'Huge', H, 202965578),
  makePet('Huge Wild Galaxy Agony', '126232720900762', 'Huge', H, 206222866),
  makePet('Huge Vampire Bat', '14976574393', 'Huge', H, 199057203),
  makePet('Huge Jungle Golem', '125686962742036', 'Huge', H, 203617279),
  makePet('Huge Classic Dragon', '18883372375', 'Huge', H, 201054087),
  makePet('Huge Evolved Pterodactyl', '14976427082', 'Huge', H, 200919944),
  makePet('Huge Divinus', '18152335113', 'Huge', H, 198815766),
  makePet('Huge Abstract Dominus', '138676503703270', 'Huge', H, 189869317),
  makePet('Huge Snuggle Beast', '121269844135033', 'Huge', H, 193736910),
  makePet('Huge Pirate Parrot', '14976518880', 'Huge', H, 192698176),
  makePet('Huge Starry Owl', '75830065128767', 'Huge', H, 192509365),
  makePet('Huge Panther', '127123894075183', 'Huge', H, 199467544),
  makePet('Huge Ancient Dragon', '18626986876', 'Huge', H, 182275977),
  makePet('Huge Bejeweled Lion', '17450309030', 'Huge', H, 191829527),
  makePet('Huge Triceratops', '18758757156', 'Huge', H, 191711502),
  makePet('Huge Prison Cow', '79315838011992', 'Huge', H, 175613721),
  makePet('Huge Angel Cow', '136952666611096', 'Huge', H, 175788687),
  makePet('Huge Umbrella Cat', '14976572705', 'Huge', H, 189762916),
  makePet('Huge Jurassic Beaver', '97754526096215', 'Huge', H, 180542695),
  makePet('Huge Diamond Dog', '16250896717', 'Huge', H, 182302656),
  makePet('Huge Sprout Wyrmling', '117238217692099', 'Huge', H, 137197320),
  makePet('Huge Stargazing Wolf', '17602431693', 'Huge', H, 185006674),
  makePet('Huge Empyrean Agony', '14976421040', 'Huge', H, 179733856),
  makePet('Huge Dot Matrix Cat', '118273434697077', 'Huge', H, 173299335),
  makePet('Huge Kawaii Tiger', '18539512677', 'Huge', H, 179887575),
  makePet('Huge Googly Corgi', '127100039471519', 'Huge', H, 185676471),
  makePet('Huge Masked Owl', '14976487652', 'Huge', H, 174126320),
  makePet('Huge Forged Cyclops', '108970973027495', 'Huge', H, 172325460),
  makePet('Huge Unicorn Dragon', '15163489495', 'Huge', H, 175258138),
  makePet('Huge Red Fluffy', '14976533036', 'Huge', H, 172556576),
  makePet('Huge Dove', '14976414513', 'Huge', H, 167964735),
  makePet('Huge Yin-Yang Dragon', '139547008385454', 'Huge', H, 176495095),
  makePet('Huge Totem Cat', '94635272523111', 'Huge', H, 165547819),
  makePet('Huge Pot of Gold Corgi', '106744072159762', 'Huge', H, 162043923),
  makePet('Huge Kawaii Dragon', '14976470932', 'Huge', H, 165245313),
  makePet('Huge Evolved King Cobra', '14976426069', 'Huge', H, 165596214),
  makePet('Huge Classic Dog', '18883372166', 'Huge', H, 155071400),
  makePet('Huge Cheerful Yeti', '14976375591', 'Huge', H, 163169385),
  makePet('Huge Kaiju Sea Dragon', '77556334425969', 'Huge', H, 168436276),
  makePet('Huge Stargazing Axolotl', '17602432142', 'Huge', H, 159012402),
  makePet('Huge Tech Chest Mimic', '14976490534', 'Huge', H, 154991828),
  makePet('Huge Evolved Peacock', '14976426399', 'Huge', H, 154135495),
  makePet('Huge Midnight Zebra', '137637076572981', 'Huge', H, 156088585),
  makePet('Huge Skeleton Shark', '87082066811704', 'Huge', H, 146283733),
  makePet('Huge Sketch Corgi', '17027110720', 'Huge', H, 155654745),
  makePet('Huge Valkyrie Dog', '18465101315', 'Huge', H, 155043657),
  makePet('Huge Jelly Kitsune', '98444936936302', 'Huge', H, 149330639),
  makePet('Huge Storm Axolotl Ball', '123709369335154', 'Huge', H, 150355678),
  makePet('Huge Hydra Dino', '18741937148', 'Huge', H, 152756023),
  makePet('Huge Night Terror Cat', '17451173023', 'Huge', H, 156675986),
  makePet('Huge Bubble Hydra', '88580020696117', 'Huge', H, 152486915),
  makePet('Huge Flex Tiger', '18127488955', 'Huge', H, 150109658),
  makePet('Huge Runebound Bobcat', '75929351206941', 'Huge', H, 139366916),
  makePet('Huge Treasure Turtle', '18556268254', 'Huge', H, 147369482),
  makePet('Huge Soul Cat', '114453311306931', 'Huge', H, 143181504),
  makePet('Huge Nightmare Dog', '78024171936128', 'Huge', H, 148063180),
  makePet('Huge Watermelon Golem', '79014602144468', 'Huge', H, 144648717),
  makePet('Huge Toy Duck', '118862307433647', 'Huge', H, 143189562),
  makePet('Huge Tarantula', '124339060912566', 'Huge', H, 141769862),
  makePet('Huge Devil Agony', '18256894534', 'Huge', H, 142169436),
  makePet('Huge Graffiti Raccoon', '120010094799102', 'Huge', H, 140830939),
  makePet('Huge Luchador Eagle', '92111973498255', 'Huge', H, 133770802),
  makePet('Huge Patchwork Teddy Bear', '101792961428557', 'Huge', H, 136662794),
  makePet('Huge Masked Fox', '17749184083', 'Huge', H, 133990189),
  makePet('Huge Fragmented Pterodactyl', '89915786412548', 'Huge', H, 96096150),
  makePet('Huge Chameleon', '14976375382', 'Huge', H, 131788804),
  makePet('Huge Blazing Shark', '17749190912', 'Huge', H, 136313758),
  makePet('Huge Pot of Gold Cat', '123890112908568', 'Huge', H, 129854489),
  makePet('Huge Chef Monkey', '14976376567', 'Huge', H, 130403943),
  makePet('Huge Electric Cat', '16914837316', 'Huge', H, 126823551),
  makePet('Huge Hypnotic Cat', '111380702185705', 'Huge', H, 125296286),
  makePet('Huge Robber Cat', '17604035571', 'Huge', H, 126715613),
  makePet('Huge Mucki', '126924768939379', 'Huge', H, 121931573),
  makePet('Huge Purple Dragon', '16251004392', 'Huge', H, 115362605),
  makePet('Huge Bejeweled Unicorn', '17450309349', 'Huge', H, 124682346),
  makePet('Huge Devil Dominus', '18256894835', 'Huge', H, 125354557),
  makePet('Huge Raptor', '18758705093', 'Huge', H, 120559847),
  makePet('Huge Nightmare Sludge', '100374100910394', 'Huge', H, 123027643),
  makePet('Huge Tiedye Corgi', '14976569398', 'Huge', H, 118034609),
  makePet('Huge Honey Golem', '137790687877183', 'Huge', H, 119571499),
  makePet('Huge Pixel Tiger', '91955794019105', 'Huge', H, 117350445),
  makePet('Huge Chad Elephant', '125515994456210', 'Huge', H, 120507501),
  makePet('Huge Exquisite Cat', '14976427289', 'Huge', H, 122401659),
  makePet('Huge Easter Golem', '98455133654568', 'Huge', H, 114687682),
  makePet('Huge Pixie Bee', '87836274620619', 'Huge', H, 120817025),
  makePet('Huge Cupid Corgi', '14976389349', 'Huge', H, 114130494),
  makePet('Huge Virus Griffin', '17857638038', 'Huge', H, 117108952),
  makePet('Huge Clover Fairy', '16744695511', 'Huge', H, 113378391),
  makePet('Huge Yin-Yang Bunny', '75417612099373', 'Huge', H, 118548065),
  makePet('Huge Party Axolotl', '14976508713', 'Huge', H, 108305655),
  makePet('Huge Treasure Golem', '77267608223080', 'Huge', H, 114826771),
  makePet('Huge Werewolf', '99136154252309', 'Huge', H, 115152579),
  makePet('Huge Meebo The Alien Ball', '105987856358688', 'Huge', H, 110351247),
  makePet('Huge Scary Cat', '15281988446', 'Huge', H, 105710361),
  makePet('Huge Dark Dragon', '74325129208178', 'Huge', H, 110900293),
  makePet('Huge Leprechaun Corgi', '121626640440926', 'Huge', H, 106552443),
  makePet('Huge Marshmallow Agony', '14976486981', 'Huge', H, 105846814),
  makePet('Huge Gingerbread Angelus', '137630213066675', 'Huge', H, 107408635),
  makePet('Huge Doodle Fairy', '14976404766', 'Huge', H, 108428523),
  makePet('Huge Elf Dog', '14976420144', 'Huge', H, 105438894),
  makePet('Huge Painted Cat', '14976507206', 'Huge', H, 105022130),
  makePet('Huge Kitsune Fox', '18352502490', 'Huge', H, 109088277),
  makePet('Huge Blossom Spirit', '91486613555331', 'Huge', H, 101694490),
  makePet('Huge Error Cat', '14976424262', 'Huge', H, 102785917),
  makePet('Huge Fireball Cat', '106665613932679', 'Huge', H, 101854983),
  makePet('Huge Jester Dog', '16746769132', 'Huge', H, 104968938),
  makePet('Huge Hi-Tech Tiger', '16472006999', 'Huge', H, 101238844),
  makePet('Huge Clover Unicorn', '14976383846', 'Huge', H, 102509675),
  makePet('Huge Ducky Magician', '113798399729190', 'Huge', H, 97220278),
  makePet('Huge UV Kitsune', '18351655777', 'Huge', H, 101035024),
  makePet('Huge Spectral Deer', '72961994800686', 'Huge', H, 99050117),
  makePet('Huge Leprechaun Kitsune', '100650487607408', 'Huge', H, 99666538),
  makePet('Huge Fire Horse', '15480654527', 'Huge', H, 100085599),
  makePet('Huge Easter Dominus', '14976417278', 'Huge', H, 101099022),
  makePet('Huge Crystal Dog', '14976388450', 'Huge', H, 97737871),
  makePet('Huge Soccer Terrier', '78064428614816', 'Huge', H, 97100931),
  makePet('Huge Witch Wolf', '133897914197133', 'Huge', H, 97834837),
  makePet('Huge Evil Snowman', '117577340597461', 'Huge', H, 96995311),
  makePet('Huge Pixel Monkey', '80158581180196', 'Huge', H, 95220011),
  makePet('Huge Lucki Golem', '82253634531547', 'Huge', H, 92718536),
  makePet('Huge Love Peacock', '126019438810546', 'Huge', H, 93702280),
  makePet('Huge Mosaic Griffin', '14976494343', 'Huge', H, 92236265),
  makePet('Huge Egg Chick', '135817707784435', 'Huge', H, 92689063),
  makePet('Huge Poseidon Dog', '14976526838', 'Huge', H, 93016863),
  makePet('Huge Tiedye Cat', '14976568867', 'Huge', H, 92675702),
  makePet('Huge Turtle', '14976572325', 'Huge', H, 91105989),
  makePet('Huge Luchador Coyote', '111458078240780', 'Huge', H, 91490307),
  makePet('Huge Scary Corgi', '15281988264', 'Huge', H, 90382344),
  makePet('Huge Floatie Penguin', '90846690350439', 'Huge', H, 91130187),
  makePet('Huge Flex Fluffy Cat', '18127488650', 'Huge', H, 93239112),
  makePet('Huge Cappuccina Brainrot', '110814000442591', 'Huge', H, 87870561),
  makePet('Huge Wishing Dragon', '106906458368266', 'Huge', H, 90729104),
  makePet('Huge Coach Tiger', '72728231743832', 'Huge', H, 89964386),
  makePet('Huge Elf Cat', '14976419865', 'Huge', H, 91259056),
  makePet('Huge Disco Ball Dragon', '18458208582', 'Huge', H, 88948147),
  makePet('Huge Enchanted Deer', '14976423228', 'Huge', H, 90691014),
  makePet('Huge Love Lion', '123099034281785', 'Huge', H, 86612535),
  makePet('Huge Leprechaun Cat', '14976475596', 'Huge', H, 88415596),
  makePet('Huge Special Ops Dog', '88026158372953', 'Huge', H, 84546782),
  makePet('Huge Strawberry Corgi', '15634002728', 'Huge', H, 85529749),
  makePet('Huge Evolved Icy Phoenix', '137094796065163', 'Huge', H, 86519452),
  makePet('Huge Wave Spirit', '101464830006395', 'Huge', H, 85861367),
  makePet('Huge Boxing Elephant', '110943916892100', 'Huge', H, 86810082),
  makePet('Huge Arcade Angelus', '119811643774598', 'Huge', H, 85516571),
  makePet('Huge Easter Angelus', '102295861032789', 'Huge', H, 82933953),
  makePet('Huge Pixel Yeti', '131996280038414', 'Huge', H, 84245840),
  makePet('Huge Luau Cat', '14976477787', 'Huge', H, 84047155),
  makePet('Huge Slasher Sloth', '115427285712502', 'Huge', H, 84568198),
  makePet('Huge Tiedye Axolotl', '14976567779', 'Huge', H, 82465488),
  makePet('Huge Jolly Owl', '103505479597539', 'Huge', H, 82596527),
  makePet('Huge Evolved Hell Rock', '14976425869', 'Huge', H, 82689802),
  makePet('Huge Gym Scorpion', '82303153411870', 'Huge', H, 81832076),
  makePet('Huge Origami Shark', '89090934657295', 'Huge', H, 77445451),
  makePet('Huge Evolved Elephant', '94951927058710', 'Huge', H, 79901173),
  makePet('Huge Dark Lord', '18152338133', 'Huge', H, 81104864),
  makePet('Huge Luxe Axolotl', '96174972080942', 'Huge', H, 64387737),
  makePet('Huge Cyborg Dragon', '14976392605', 'Huge', H, 79572545),
  makePet('Huge Totem Wolf', '130997023659211', 'Huge', H, 80657376),
  makePet('Huge Hacked Reaper', '119356588704518', 'Huge', H, 78498767),
  makePet('Huge Ghost Axolotl', '78816523921536', 'Huge', H, 79909010),
  makePet('Huge Hell Monkey', '75557706152622', 'Huge', H, 79294932),
  makePet('Huge Mosaic Corgi', '14976493326', 'Huge', H, 77486346),
  makePet('Huge Guard Hydra', '79622017350328', 'Huge', H, 80378146),
  makePet('Huge Atomic Axolotl', '17515613028', 'Huge', H, 79226945),
  makePet('Huge Pixel Dragon', '14976521054', 'Huge', H, 79057216),
  makePet('Huge Platypus', '81423443378217', 'Huge', H, 60450249),
  makePet('Huge Meebo in a Spaceship', '14976488429', 'Huge', H, 78335856),
  makePet('Huge Party Crown Hippomelon', '105303258618878', 'Huge', H, 79701124),
  makePet('Huge Guard Dragon', '106968856805193', 'Huge', H, 77248591),
  makePet('Huge Pineapple Cat', '14976517235', 'Huge', H, 75461190),
  makePet('Huge Evolved Kangaroo', '80169939922601', 'Huge', H, 77368704),
  makePet('Huge Easter Agony', '117110951312046', 'Huge', H, 75066160),
  makePet('Huge Jetpack Cat', '112353118554284', 'Huge', H, 75799279),
  makePet('Huge Jurassic Crocodile', '116989921255882', 'Huge', H, 74665668),
  makePet('Huge Naughty Dominus', '75328747799299', 'Huge', H, 76291318),
  makePet('Huge Trojan Horse', '127674627495853', 'Huge', H, 75456114),
  makePet('Huge Super Coral Axolotl', '123726574453022', 'Huge', H, 74644275),
  makePet('Huge Pumpkin Dog', '71270630021360', 'Huge', H, 74797366),
  makePet('Huge Plague Dragon', '17375065126', 'Huge', H, 76154563),
  makePet('Huge Sleigh Axolotl', '77508464202964', 'Huge', H, 73036170),
  makePet('Huge Electric Werewolf', '126966146144158', 'Huge', H, 74228119),
  makePet('Huge Elf Golem', '119266692715617', 'Huge', H, 74181210),
  makePet('Huge LeGoat Ball', '85572580085074', 'Huge', H, 74889269),
  makePet('Huge Patchwork Bunny', '120785546705705', 'Huge', H, 74176393),
  makePet('Huge Easter Bunny', '14976566967', 'Huge', H, 73136456),
  makePet('Huge Tiedye Bunny', '14976568628', 'Huge', H, 73860093),
  makePet('Huge Enchanted Dog', '98036079803445', 'Huge', H, 75064867),
  makePet('Huge Chef Cat', '15281989941', 'Huge', H, 73301570),
  makePet('Huge Chill Sloth', '120533708082734', 'Huge', H, 73696163),
  makePet('Huge Evolved Bison', '98184057731755', 'Huge', H, 73595623),
  makePet('Huge Rose Cat', '103846288511073', 'Huge', H, 74391576),
  makePet('Huge Holiday Pegasus', '15716049550', 'Huge', H, 73370933),
  makePet('Huge Pastel Sock Bear', '84261728017151', 'Huge', H, 73209610),
  makePet('Huge Inferno Stealth Bobcat', '18644411865', 'Huge', H, 66411697),
  makePet('Huge Doodle Dragon', '103476619059265', 'Huge', H, 72396862),
  makePet('Huge Naughty Cat', '87910318681243', 'Huge', H, 69988527),
  makePet('Huge Goldfish', '95752779695636', 'Huge', H, 46092143),
  makePet('Huge Guard Wolf', '120663531720305', 'Huge', H, 71062407),
  makePet('Huge Jolly Penguin', '14976469674', 'Huge', H, 70454834),
  makePet('Huge Police Cat', '17588549479', 'Huge', H, 69657070),
  makePet('Huge Parrot', '106937805162090', 'Huge', H, 67969459),
  makePet('Huge Garden Goblin', '97942779030547', 'Huge', H, 53426370),
  makePet('Huge Shadow Dominus', '15804010569', 'Huge', H, 69231781),
  makePet('Huge Mech Dino', '18673257007', 'Huge', H, 68761539),
  makePet('Huge Leafstorm Wolf', '139340972718086', 'Huge', H, 68556992),
  makePet('Huge Guest Noob', '14976448855', 'Huge', H, 69646056),
  makePet('Huge Snowflake Dominus', '83373370051521', 'Huge', H, 68584872),
  makePet('Huge Flamethrower Spider', '73032919339096', 'Huge', H, 69184088),
  makePet('Huge Good vs Evil Cat', '18155109260', 'Huge', H, 69859452),
  makePet('Huge Atomic Forged Shark', '18978050454', 'Huge', H, 69631079),
  makePet('Huge Jaguar', '121900456724248', 'Huge', H, 67561349),
  makePet('Huge Lucki Angelus', '139803624702732', 'Huge', H, 68398883),
  makePet('Huge Skeleton', '14976548258', 'Huge', H, 67810090),
  makePet('Huge Candycane', '103105073784990', 'Huge', H, 66609946),
  makePet('Huge Carnival Panda', '92219735800314', 'Huge', H, 57674618),
  makePet('Huge Candycane Kitsune', '74407552054754', 'Huge', H, 64246389),
  makePet('Huge Crash Dummy Noob', '138395333405462', 'Huge', H, 65604099),
  makePet('Huge Shattered Heart Agony', '129768641287127', 'Huge', H, 65042063),
  makePet('Huge Pterodactyl', '14976527837', 'Huge', H, 63513754),
  makePet('Huge Arcade Dragon', '16756391066', 'Huge', H, 61016181),
  makePet('Huge Librarian Beaver', '103600701852967', 'Huge', H, 62575423),
  makePet('Huge Hell Rock', '14976455394', 'Huge', H, 61390421),
  makePet('Huge Raining Love Dog', '73797455811877', 'Huge', H, 63344462),
  makePet('Huge Evolved Easter Lamb', '114656946868089', 'Huge', H, 61097070),
  makePet('Huge Ooze Corgi', '140383295631296', 'Huge', H, 61642775),
  makePet('Huge Sage Axolotl', '18256895424', 'Huge', H, 62825401),
  makePet('Huge Pumpkin Scarecrow', '116673779811156', 'Huge', H, 62692729),
  makePet('Huge Minecart Piggy', '106752259915805', 'Huge', H, 61566015),
  makePet('Huge Stealth Bobcat', '14976557639', 'Huge', H, 60377180),
  makePet('Huge Withered Agony', '127219457030426', 'Huge', H, 49221913),
  makePet('Huge Clover Lion', '123334593122447', 'Huge', H, 60896465),
  makePet('Huge Evil Kitsune', '122958548174928', 'Huge', H, 59551987),
  makePet('Huge Beans Balloon Cat', '14976361583', 'Huge', H, 58651391),
  makePet('Huge Lucki Monkey', '114063062613222', 'Huge', H, 59866033),
  makePet('Huge Knight Slime', '93884562630486', 'Huge', H, 59320815),
  makePet('Huge Inferno Stealth Cat', '18644412090', 'Huge', H, 59744057),
  makePet('Huge Stealth Dragon', '14976557966', 'Huge', H, 58689173),
  makePet('Huge Scarecrow Cat', '14976543713', 'Huge', H, 56520364),
  makePet('Huge Sloth', '77873746102691', 'Huge', H, 58801478),
  makePet('Huge Krampus', '127076260732138', 'Huge', H, 59009838),
  makePet('Huge Honey Bear', '83794143197410', 'Huge', H, 59352759),
  makePet('Huge Warrior Wolf', '18256895705', 'Huge', H, 57932583),
  makePet('Huge Autumn Red Panda', '119442470085082', 'Huge', H, 57270614),
  makePet('Huge Evolved Rogue Squid', '88584631141101', 'Huge', H, 58670303),
  makePet('Huge Obsidian Griffin', '105493952601280', 'Huge', H, 58551313),
  makePet('Huge Bearserker', '14976362435', 'Huge', H, 58242082),
  makePet('Huge Baby Kitten', '108106366016899', 'Huge', H, 58257810),
  makePet('Huge Lumi Axolotl', '16410740491', 'Huge', H, 55657068),
  makePet('Huge Royal Pooka', '80049481266814', 'Huge', H, 57485237),
  makePet('Huge Yee-haw Cat', '85182651602746', 'Huge', H, 58824047),
  makePet('Huge Evolved Frankenpup Dog', '85621910541891', 'Huge', H, 57444831),
  makePet('Huge Abomination', '70697028891589', 'Huge', H, 57408648),
  makePet('Huge Rich Cat', '16744715368', 'Huge', H, 55285174),
  makePet('Huge Toy Chest Mimic', '111386850399193', 'Huge', H, 56081832),
  makePet('Huge Evolved Player Fox', '88581357457195', 'Huge', H, 58192252),
  makePet('Huge Pastel Elephant', '16498745846', 'Huge', H, 56489448),
  makePet('Huge King Cobra', '14976472289', 'Huge', H, 55995692),
  makePet('Huge Pristine Snake', '18556267952', 'Huge', H, 54656288),
  makePet('Huge Evil Imp', '18150534002', 'Huge', H, 54306627),
  makePet('Huge Super Spider', '118018926499852', 'Huge', H, 54799747),
  makePet('Huge Aura Fox', '102863074844102', 'Huge', H, 54884006),
  makePet('Huge Valentines Dominus', '79026289241532', 'Huge', H, 54697269),
  makePet('Huge Clover Butterfly', '111786177414558', 'Huge', H, 54023111),
  makePet('Huge Gecko', '14976440578', 'Huge', H, 51104878),
  makePet('Huge Hell Spider', '92181296313546', 'Huge', H, 52880228),
  makePet('Huge Bobcat', '117053043329448', 'Huge', H, 51603592),
  makePet('Huge Avenging Griffin', '18150841344', 'Huge', H, 52797869),
  makePet('Huge Mosaic Lamb', '14976494608', 'Huge', H, 53059007),
  makePet('Huge Rave Butterfly', '18458208075', 'Huge', H, 51401107),
  makePet('Huge Evolved Pixel Griffin', '121188358881521', 'Huge', H, 51864431),
  makePet('Huge Rave Meebo in a Spaceship', '18351654787', 'Huge', H, 52580896),
  makePet('Huge Elemental Phoenix', '106964408163546', 'Huge', H, 51564419),
  makePet('Huge Egg Dino', '18741936725', 'Huge', H, 52312900),
  makePet('Huge Crystal Bat', '123270270237540', 'Huge', H, 51186750),
  makePet('Huge Slimezilla', '133814850196289', 'Huge', H, 49753366),
  makePet('Huge Pirate Dog', '128373074804496', 'Huge', H, 52334012),
  makePet('Huge Jelly Wizard', '84699945958141', 'Huge', H, 51006605),
  makePet('Huge Merry Manatee', '125341685392478', 'Huge', H, 51138732),
  makePet('Huge Angel Dragon', '118966983027329', 'Huge', H, 51282621),
  makePet('Huge Guard Dominus', '125199678702615', 'Huge', H, 49270125),
  makePet('Huge Sorcerer Bear', '18978051040', 'Huge', H, 50153849),
  makePet('Huge Jetpack Tiger', '124866391707961', 'Huge', H, 50765024),
  makePet('Huge Exquisite Parrot', '14976427729', 'Huge', H, 50135792),
  makePet('Huge Corrupt Butterfly', '18882974863', 'Huge', H, 50395864),
  makePet('Huge Lucki Wolf', '98519377335101', 'Huge', H, 48987906),
  makePet('Huge Pixel Corgi', '14976519576', 'Huge', H, 50067608),
  makePet('Huge Special Ops Ram', '73165145533261', 'Huge', H, 47803644),
  makePet('Huge Autumn Retriever', '127760564297635', 'Huge', H, 49168965),
  makePet('Huge Reindeer Agony', '126523808307279', 'Huge', H, 47219851),
  makePet('Huge Quartz Fox', '129331981737475', 'Huge', H, 47963684),
  makePet('Huge Dino', '108545390694992', 'Huge', H, 45093862),
  makePet('Huge Hacker Axolotl', '17769626736', 'Huge', H, 47556590),
  makePet('Huge Abyssal Axolotl', '16471981261', 'Huge', H, 48018993),
  makePet('Huge Pixie Fox', '17835929068', 'Huge', H, 47479266),
  makePet('Huge Demolition Cat', '128405982771054', 'Huge', H, 44913491),
  makePet('Huge Willow Wisp', '14976579205', 'Huge', H, 46013613),
  makePet('Huge Rootkin Fox', '76545663190754', 'Huge', H, 46854601),
  makePet('Huge Devil Tasmanian', '128236274006069', 'Huge', H, 45872946),
  makePet('Huge Gym Corgi', '100837906576069', 'Huge', H, 44398346),
  makePet('Huge Evolved Stingray', '132084946919332', 'Huge', H, 47428120),
  makePet('Huge Holiday Dove', '109237504369086', 'Huge', H, 46077792),
  makePet('Huge Knight Golem', '86043823769760', 'Huge', H, 46210101),
  makePet('Huge Evolved Evil Raven', '139468425219654', 'Huge', H, 46451178),
  makePet('Huge Anime Scorpion', '81320739190462', 'Huge', H, 45357509),
  makePet('Huge Leafy Deer', '74179288771824', 'Huge', H, 46547152),
  makePet('Huge Dino Dog', '18673255790', 'Huge', H, 44447260),
  makePet('Huge Cyber Agony', '16472011675', 'Huge', H, 45714156),
  makePet('Huge Ice Cube Penguin', '70749719164578', 'Huge', H, 46224509),
  makePet('Huge Mystical Whale', '128951201901873', 'Huge', H, 45518841),
  makePet('Huge Pixel Shadow Griffin', '138870297063423', 'Huge', H, 43954487),
  makePet('Huge Happy Computer', '16472013395', 'Huge', H, 43538671),
  makePet('Huge Gym Anteater', '113847537674540', 'Huge', H, 45945887),
  makePet('Huge Wicked Kirin', '80510335066918', 'Huge', H, 43905141),
  makePet('Huge Hippo', '14976456459', 'Huge', H, 44251099),
  makePet('Huge Peacock', '14976514269', 'Huge', H, 44942819),
  makePet('Huge Present Dragon', '78320766313104', 'Huge', H, 46485246),
  makePet('Huge Gorilla', '107479430028155', 'Huge', H, 41739636),
  makePet('Huge Gym Cow', '110341807315948', 'Huge', H, 43249907),
  makePet('Huge Evolved Scarecrow Dog', '72439149479995', 'Huge', H, 45458956),
  makePet('Huge Player Penguin', '121118923201338', 'Huge', H, 44560832),
  makePet('Huge Gym Beaver', '139877425237704', 'Huge', H, 42633285),
  makePet('Huge Skelemelon', '139632770230401', 'Huge', H, 41993941),
  makePet('Huge Alien', '123487033962716', 'Huge', H, 40825519),
  makePet('Huge Treasure Scorpion', '124383446911252', 'Huge', H, 40176532),
  makePet('Huge Marshmallow Kitsune', '95357265380757', 'Huge', H, 41504372),
  makePet('Huge Arcade Meebo in a Spaceship', '72018720220470', 'Huge', H, 40277590),
  makePet('Huge Dark Fox', '133312153663051', 'Huge', H, 41585217),
  makePet('Huge Shuriken Corgi', '18978050838', 'Huge', H, 41310966),
  makePet('Huge Nuclear Wild Dog', '18978050650', 'Huge', H, 40656532),
  makePet('Huge Bat', '14976360459', 'Huge', H, 40009516),
  makePet('Huge Snow Crab', '115554189574949', 'Huge', H, 40481704),
  makePet('Huge Ghostly Dragon', '93813808986344', 'Huge', H, 38717546),
  makePet('Huge Evolved Mining Penguin', '124239395763286', 'Huge', H, 40929349),
  makePet('Huge Lifeguard Shark', '75963541478121', 'Huge', H, 41029374),
  makePet('Huge Fragmented Dominus Ball', '100875909675761', 'Huge', H, 41466151),
  makePet('Huge Water Zebra', '132338879904830', 'Huge', H, 40572996),
  makePet('Huge Love Corgi', '112650153241543', 'Huge', H, 39339812),
  makePet('Huge Spitting Dino', '75776145321145', 'Huge', H, 39567689),
  makePet('Huge Mantis Shrimp', '83192948454394', 'Huge', H, 40406425),
  makePet('Huge Evolved Basket Bunny', '117009470735471', 'Huge', H, 40316147),
  makePet('Huge Rave Troll', '18351655132', 'Huge', H, 38948465),
  makePet('Huge Electric Dino', '18673256682', 'Huge', H, 39766045),
  makePet('Huge Hydra Axolotl', '76323621337981', 'Huge', H, 39355436),
  makePet('Huge Wild Frost Agony', '80433316929327', 'Huge', H, 37644733),
  makePet('Huge Squirrel', '14976555755', 'Huge', H, 39686836),
  makePet('Huge Coconut Corgi', '92543943369771', 'Huge', H, 39629145),
  makePet('Huge Sleigh Cat', '121879397544213', 'Huge', H, 38777790),
  makePet('Huge Abyssal Jellyfish', '18882975166', 'Huge', H, 39139770),
  makePet('Huge Temporal Owl', '18882992626', 'Huge', H, 38373345),
  makePet('Huge Jolly Narwhal', '14976825062', 'Huge', H, 39377897),
  makePet('Huge Mechatronic Robot', '18882975779', 'Huge', H, 38093698),
  makePet('Huge Blurred Axolotl', '89638501740571', 'Huge', H, 38756543),
  makePet('Huge Electric Bunny Ball', '102519001047451', 'Huge', H, 39387633),
  makePet('Huge Luxe Peacock', '18556267256', 'Huge', H, 37838783),
  makePet('Huge Rave Slime', '118307691118910', 'Huge', H, 37554978),
  makePet('Huge Happy Rock', '14976450873', 'Huge', H, 36607596),
  makePet('Huge Fluffy Cat', '15803982174', 'Huge', H, 37212222),
  makePet('Huge Shadow Pegasus', '131804456105000', 'Huge', H, 37460596),
  makePet('Huge Kawaii Dragon Ball', '108289198978887', 'Huge', H, 36837419),
  makePet('Huge Atomic Monkey Ball', '131025673327487', 'Huge', H, 36952092),
  makePet('Huge Origami Bunny', '83483274094182', 'Huge', H, 35807516),
  makePet('Huge Valentines Bear', '140051319290107', 'Huge', H, 26762083),
  makePet('Huge Evolved Red Wolf', '126635488798392', 'Huge', H, 38505613),
  makePet('Huge Poseidon Corgi', '15477703422', 'Huge', H, 37257383),
  makePet('Huge Galaxy Fox', '78675251181083', 'Huge', H, 35057444),
  makePet('Huge Vibrant Whale', '87407901102081', 'Huge', H, 31198683),
  makePet('Huge Crystal Spider', '78631219465603', 'Huge', H, 36613575),
  makePet('Huge Snowflake Dragon', '113631496802759', 'Huge', H, 35339475),
  makePet('Huge Red Panda', '14976533293', 'Huge', H, 36167738),
  makePet('Huge Loveserker', '100447142740271', 'Huge', H, 36694184),
  makePet('Huge Holographic Cat', '17515615256', 'Huge', H, 35456013),
  makePet('Huge Lit Cat', '93603448962886', 'Huge', H, 34484706),
  makePet('Huge Holiday Hedgehog', '104271630769332', 'Huge', H, 35787354),
  makePet('Huge Gorgon', '82639968294910', 'Huge', H, 34803434),
  makePet('Huge Alienus Kitsune', '135920143312386', 'Huge', H, 35036106),
  makePet('Huge Inkwell Wisp', '92033856546098', 'Huge', H, 31415001),
  makePet('Huge Rave Jaguar', '18458263548', 'Huge', H, 34836921),
  makePet('Huge Relic Deer', '113333249087302', 'Huge', H, 35274664),
  makePet('Huge Penguin', '118584949011008', 'Huge', H, 33463133),
  makePet('Huge Evolved Starry Eye Bunny', '76225100606605', 'Huge', H, 33946053),
  makePet('Huge Student Corgi', '129996809182527', 'Huge', H, 33759421),
  makePet('Huge Electric Slime', '134465209106329', 'Huge', H, 31404459),
  makePet('Huge Teacher Cat', '108033517958051', 'Huge', H, 33549925),
  makePet('Huge Gym Shark', '96513161978756', 'Huge', H, 32489198),
  makePet('Huge Sea Dragon', '109192796689135', 'Huge', H, 33738565),
  makePet('Huge Glowy the Ghost', '80650774485901', 'Huge', H, 35356446),
  makePet('Huge Colorful Wisp', '16410753529', 'Huge', H, 33871118),
  makePet('Huge Wizard Westie', '14976579774', 'Huge', H, 32349011),
  makePet('Huge Mushroom Snail', '106278894381097', 'Huge', H, 33505559),
  makePet('Huge Pumpkin Spice Cat', '126378743286438', 'Huge', H, 32773225),
  makePet('Huge Pineapple Monkey', '17689399533', 'Huge', H, 33516731),
  makePet('Huge Heartbreak Fairy', '129589212875010', 'Huge', H, 32161288),
  makePet('Huge Ancestor Eagle', '95278046256593', 'Huge', H, 30165899),
  makePet('Huge Veil Horse', '137004945467080', 'Huge', H, 23984166),
  makePet('Huge Whale Shark', '16725471591', 'Huge', H, 33304961),
  makePet('Huge Diamond Bunny', '100376851450682', 'Huge', H, 32704292),
  makePet('Huge Emerald Owl', '86244728271610', 'Huge', H, 32190974),
  makePet('Huge Gym Panda', '139794409376900', 'Huge', H, 32653082),
  makePet('Huge Knight Beagle', '15804006339', 'Huge', H, 32614040),
  makePet('Huge Lotus Koi Fish', '128936875098689', 'Huge', H, 26876919),
  makePet('Huge Rainbow Slime', '14976531943', 'Huge', H, 32180647),
  makePet('Huge Lightning Bat', '94725312781292', 'Huge', H, 32130577),
  makePet('Huge Hippomint', '105962472084546', 'Huge', H, 32879211),
  makePet('Huge Spring Dragon', '83560994028636', 'Huge', H, 32962972),
  makePet('Huge Coconut Flamingo', '124659391100423', 'Huge', H, 32804460),
  makePet('Huge Prison Cat', '17526083509', 'Huge', H, 31795869),
  makePet('Huge Horseshoe Capybara', '79249687154942', 'Huge', H, 31660948),
  makePet('Huge Ghost', '14976441222', 'Huge', H, 32576093),
  makePet('Huge Quantum Griffin', '103033034897992', 'Huge', H, 28992928),
  makePet('Huge Old Wizard Corgi', '18644412561', 'Huge', H, 32121600),
  makePet('Huge Mushroom Dragon', '98526628952494', 'Huge', H, 31893254),
  makePet('Huge Fossil Dragon', '14976436145', 'Huge', H, 31410940),
  makePet('Huge Evolved Mining Monkey', '108431740887325', 'Huge', H, 32052302),
  makePet('Huge Blue Lucky Block', '116957138915362', 'Huge', H, 30727428),
  makePet('Huge Nutcracker Cat', '131785972720265', 'Huge', H, 30461748),
  makePet('Huge Glitched Unicorn Ball', '129837188566308', 'Huge', H, 31613774),
  makePet('Huge Icy Phoenix', '77587429055460', 'Huge', H, 30811676),
  makePet('Huge Valentines Axolotl', '92646115385136', 'Huge', H, 31872139),
  makePet('Huge Sunflower Calf', '89310738281949', 'Huge', H, 31968715),
  makePet('Huge Dawn Phoenix', '104154597023155', 'Huge', H, 30975639),
  makePet('Huge Bloom Dominus', '86640323792392', 'Huge', H, 30486475),
  makePet('Huge Party Crown Corgi', '84718989767415', 'Huge', H, 30378077),
  makePet('Huge Pinecone Porcupine', '128031048512623', 'Huge', H, 31350611),
  makePet('Huge Old Wizard Owl', '18644413008', 'Huge', H, 30940746),
  makePet('Huge Tropical Toucan', '18644414181', 'Huge', H, 30267079),
  makePet('Huge Bunny Cat', '96756728639986', 'Huge', H, 29597567),
  makePet('Huge Party Corgi', '115749071497654', 'Huge', H, 30138760),
  makePet('Huge African Wild Dog', '137866343628136', 'Huge', H, 31551724),
  makePet('Huge Minecart Hamster', '106601892793198', 'Huge', H, 30559644),
  makePet('Huge Snowflake Pegasus', '128323283709486', 'Huge', H, 29453678),
  makePet('Huge Party Dragon', '16901792712', 'Huge', H, 30191428),
  makePet('Huge Poinsettia Peacock', '126024044464158', 'Huge', H, 29464959),
  makePet('Huge Propeller Cat', '15340315459', 'Huge', H, 30420631),
  makePet('Huge Holly Fawn', '123821214219134', 'Huge', H, 29920383),
  makePet('Huge Arcade Dog', '102621669325796', 'Huge', H, 29672615),
  makePet('Huge Holly Capybara', '113623794189618', 'Huge', H, 30213339),
  makePet('Huge Party Squirrel', '108200825731940', 'Huge', H, 29559535),
  makePet('Huge Basketball Corgi', '88019287527866', 'Huge', H, 29213955),
  makePet('Huge Electric Penguin', '77658045662575', 'Huge', H, 29826771),
  makePet('Huge Goblin', '14976446202', 'Huge', H, 30096289),
  makePet('Huge Cataclysm Bear', '126636577464770', 'Huge', H, 29795646),
  makePet('Huge Ice Snake', '72721925435619', 'Huge', H, 30017635),
  makePet('Huge Mermaid Cat', '14976489487', 'Huge', H, 30488377),
  makePet('Huge Robot', '110205883813636', 'Huge', H, 29099354),
  makePet('Huge Fiddlefern Cat', '106766832972765', 'Huge', H, 29632681),
  makePet('Huge Palace Pooka', '120508025732029', 'Huge', H, 26324939),
  makePet('Huge Valentines Unicorn', '87559926254835', 'Huge', H, 28898787),
  makePet('Huge Player Panda', '98031004094644', 'Huge', H, 29484148),
  makePet('Huge Anglerfish', '102757425603718', 'Huge', H, 29666681),
  makePet('Huge Horse', '112696303683971', 'Huge', H, 28175655),
  makePet('Huge Chocolate Bunny', '79481017800505', 'Huge', H, 27089050),
  makePet('Huge Bee', '14976362778', 'Huge', H, 29198260),
  makePet('Huge Chill Bunny', '87108901678067', 'Huge', H, 28968091),
  makePet('Huge Surfboard Axolotl', '134895528303880', 'Huge', H, 28403900),
  makePet('Huge Spring Bee', '137687744712532', 'Huge', H, 28563677),
  makePet('Huge Skeleton Cat', '99657539993632', 'Huge', H, 28183146),
  makePet('Huge Stunt Cat', '80484506977971', 'Huge', H, 27913761),
  makePet('Huge Giraffe', '14976442623', 'Huge', H, 26899280),
  makePet('Huge Spring Dino', '99022978600130', 'Huge', H, 28515494),
  makePet('Huge Lunar Moth', '17028306654', 'Huge', H, 28364417),
  makePet('Huge Robber Pug', '15804001482', 'Huge', H, 27993578),
  makePet('Huge Blurred Bear Ball', '133058816387774', 'Huge', H, 27579250),
  makePet('Huge Chill Polar Bear', '124471089861865', 'Huge', H, 27722710),
  makePet('Huge Lamb Wolf', '72351620062304', 'Huge', H, 27287364),
  makePet('Huge Spring Kitten', '129393017030092', 'Huge', H, 27863736),
  makePet('Huge Butterfly Pony', '130427218526414', 'Huge', H, 27461803),
  makePet('Huge Helicopter Cat', '14976453343', 'Huge', H, 27594414),
  makePet('Huge Diamond Chick', '79413984807049', 'Huge', H, 26243407),
  makePet('Huge Eclipse Owl', '106929390805837', 'Huge', H, 27361960),
  makePet('Huge Fancy Axolotl', '14976429135', 'Huge', H, 28015358),
  makePet('Huge Festive Seal', '121873386766313', 'Huge', H, 26316705),
  makePet('Huge Chill Parrot', '104805390421143', 'Huge', H, 27677545),
  makePet('Huge Leafy Yeti', '123501144563206', 'Huge', H, 27549159),
  makePet('Huge Pajamas Shark', '101224115872445', 'Huge', H, 28282004),
  makePet('Huge Elephant', '14976419563', 'Huge', H, 27019451),
  makePet('Huge Circuit Cat', '107640739737429', 'Huge', H, 26777860),
  makePet('Huge Telescope Owl', '81492004583287', 'Huge', H, 26311159),
  makePet('Huge Scarecrow Dog', '137318518159218', 'Huge', H, 26005162),
  makePet('Huge Coach Hippo', '99854649833028', 'Huge', H, 27752300),
  makePet('Huge Bison', '14976363344', 'Huge', H, 27563023),
  makePet('Huge Egg Piggy', '124169087472138', 'Huge', H, 27066200),
  makePet('Huge Cupcake Pegasus', '136860707312051', 'Huge', H, 25500555),
  makePet('Huge Torpedo Shepherd', '82812436217592', 'Huge', H, 27391656),
  makePet('Huge Frostbyte Snowman', '97928657452308', 'Huge', H, 27727845),
  makePet('Huge Reindeer Cat', '130929080368183', 'Huge', H, 25458573),
  makePet('Huge Totem Cub', '92882162036014', 'Huge', H, 23045689),
  makePet('Huge Spring Griffin', '138950017862417', 'Huge', H, 25496843),
  makePet('Huge Scribe Squirrel', '98604773500066', 'Huge', H, 26865844),
  makePet('Huge Holly Corgi', '70527773100023', 'Huge', H, 26629360),
  makePet('Huge Tree Frog', '109144627334415', 'Huge', H, 26031777),
  makePet('Huge Punksky', '14976529792', 'Huge', H, 27184400),
  makePet('Huge Snow Elf', '104334449359401', 'Huge', H, 25616135),
  makePet('Huge Clover Penguin', '70700548399137', 'Huge', H, 26626161),
  makePet('Huge Lucki Cat', '90438658462311', 'Huge', H, 26454763),
  makePet('Huge Pixel Bee', '123894797425389', 'Huge', H, 26194307),
  makePet('Huge Flamingo Hippo', '70985697718907', 'Huge', H, 26528137),
  makePet('Huge Ooze Axolotl', '131381022373439', 'Huge', H, 26519409),
  makePet('Huge Anubis', '132510616304685', 'Huge', H, 23833600),
  makePet('Huge Exquisite Elephant', '72880983476482', 'Huge', H, 26371747),
  makePet('Huge Pixel Otter', '98175499956412', 'Huge', H, 26132750),
  makePet('Huge Sacred Deer', '100676817290108', 'Huge', H, 26185224),
  makePet('Huge Rhino', '70742339660994', 'Huge', H, 25054976),
  makePet('Huge Chesnut Chipmunk', '134539491208069', 'Huge', H, 26827692),
  makePet('Huge Chill Ducky', '91155059443761', 'Huge', H, 26826186),
  makePet('Huge Empyrean Owl', '93292794652878', 'Huge', H, 26362233),
  makePet('Huge Player Fox', '101605254258375', 'Huge', H, 25402033),
  makePet('Huge Lunar Deer', '93191567038818', 'Huge', H, 22430477),
  makePet('Huge Jolly Dino', '88604762906611', 'Huge', H, 25494037),
  makePet('Huge Blurred Owl', '108865799258120', 'Huge', H, 25601256),
  makePet('Huge Holiday Owl', '84549305486932', 'Huge', H, 25967900),
  makePet('Huge Irish Badger', '132795639308777', 'Huge', H, 25219165),
  makePet('Huge Crocodile', '14976387300', 'Huge', H, 26419664),
  makePet('Huge Spring Onion', '75532551020815', 'Huge', H, 26233567),
  makePet('Huge Prism Pegasus', '80538613184733', 'Huge', H, 24151210),
  makePet('Huge Zombie Pig', '112915612904336', 'Huge', H, 25834989),
  makePet('Huge Lucki Hydra', '107790361850744', 'Huge', H, 24576276),
  makePet('Huge Strawhat Tanuki', '71139826265802', 'Huge', H, 25798309),
  makePet('Huge Old Wizard Cat', '80977445482365', 'Huge', H, 27391671),
  makePet('Huge Angry Yeti', '110929464319537', 'Huge', H, 25857671),
  makePet('Huge Moray Eel', '103239594752603', 'Huge', H, 26661424),
  makePet('Huge Bandana Shiba', '122819794900124', 'Huge', H, 26007375),
  makePet('Huge Kangaroo', '17208307820', 'Huge', H, 24897773),
  makePet('Huge Doll Cat', '104297588937430', 'Huge', H, 26220823),
  makePet('Huge Tropical Flamingo', '18644413250', 'Huge', H, 26365012),
  makePet('Huge Koi Fish', '16179890678', 'Huge', H, 26094792),
  makePet('Huge Lucki Elephant', '101748445167482', 'Huge', H, 25865073),
  makePet('Huge Vibrant Toucan', '17835926180', 'Huge', H, 25984698),
  makePet('Huge Lemur', '106102265443812', 'Huge', H, 24390463),
  makePet('Huge Ninja Dalmatian', '108653580991375', 'Huge', H, 25076482),
  makePet('Huge Rogue Squid', '82176106497018', 'Huge', H, 24508885),
  makePet('Huge Lucki Horse', '116756676652534', 'Huge', H, 23943080),
  makePet('Huge Mining Raccoon', '81824551142457', 'Huge', H, 25449535),
  makePet('Huge Skeleton Snake', '101412265452600', 'Huge', H, 23950206),
  makePet('Huge Clover Bee', '92697373462590', 'Huge', H, 26157995),
  makePet('Huge Candycane Shake Shark', '131205167107422', 'Huge', H, 26744347),
  makePet('Huge Mining Penguin', '107393069000800', 'Huge', H, 23842340),
  makePet('Huge Gingerbread Lion', '113905049892073', 'Huge', H, 25242898),
  makePet('Huge Ooze Cat', '94416745584783', 'Huge', H, 26177600),
  makePet('Huge Sticky Lamb', '135749996470461', 'Huge', H, 25459776),
  makePet('Huge Frostbyte Griffin', '133555995966095', 'Huge', H, 25378617),
  makePet('Huge Glade Griffin', '89142183208055', 'Huge', H, 24769055),
  makePet('Huge Tropical Parrot', '18644413700', 'Huge', H, 24733959),
  makePet('Huge Parachute Monkey', '137651133282362', 'Huge', H, 26283437),
  makePet('Huge Easter Axolotl', '140227031996665', 'Huge', H, 25562681),
  makePet('Huge Maple Owl', '79022104643180', 'Huge', H, 24605413),
  makePet('Huge Skateboard Bulldog', '14976548072', 'Huge', H, 25300777),
  makePet('Huge Robot Ball', '114904071316728', 'Huge', H, 25149569),
  makePet('Huge Starry Eye Bunny', '85579743157375', 'Huge', H, 24323793),
  makePet('Huge Red Wolf', '138120594404992', 'Huge', H, 24251455),
  makePet('Huge Spring Elephant', '137542174121503', 'Huge', H, 24301189),
  makePet('Huge Zebra', '15803989668', 'Huge', H, 26447666),
  makePet('Huge Party Panda', '102306587085097', 'Huge', H, 25454937),
  makePet('Huge Honey Badger', '14976457989', 'Huge', H, 25097782),
  makePet('Huge Hot Cocoa Bear', '103081269967606', 'Huge', H, 24215242),
  makePet('Huge Chill Turtle', '131025895273996', 'Huge', H, 24969290),
  makePet('Huge Festive Walrus', '130656165679355', 'Huge', H, 26093886),
  makePet('Huge Void Alien', '95087944303198', 'Huge', H, 25412245),
  makePet('Huge Flamingo Cat', '110362471835771', 'Huge', H, 25645382),
  makePet('Huge Lucki Tiger', '79319215201881', 'Huge', H, 24981016),
  makePet('Huge Nutcracker Squirrel', '125206420660994', 'Huge', H, 25002986),
  makePet('Huge Spotted Elephant', '109762155802208', 'Huge', H, 23198674),
  makePet('Huge Holiday Bearserker', '79863147405643', 'Huge', H, 26196402),
  makePet('Huge Festive Elf', '72695234324968', 'Huge', H, 24790784),
  makePet('Huge Gazelle', '137006734767024', 'Huge', H, 24860627),
  makePet('Huge Tennis Squirrel', '86863060232027', 'Huge', H, 24046595),
  makePet('Huge Deerserker', '74968067485946', 'Huge', H, 24406505),
  makePet('Huge Mushroom Raccoon', '14976495649', 'Huge', H, 25101668),
  makePet('Huge Bluebird', '14976368196', 'Huge', H, 23814971),
  makePet('Huge Easter Fox', '127847534239530', 'Huge', H, 25055394),
  makePet('Huge Player Corgi', '120748568564871', 'Huge', H, 24743370),
  makePet('Huge Lucki Lamb', '95284321977172', 'Huge', H, 25321543),
  makePet('Huge Leprechaun Fox', '126832578733355', 'Huge', H, 23504147),
  makePet('Huge Clover Phoenix', '121888921741628', 'Huge', H, 24646766),
  makePet('Huge North Pole Unicorn', '118783316706055', 'Huge', H, 24916813),
  makePet('Huge Stunt Corgi', '132747851336356', 'Huge', H, 24595388),
  makePet('Huge Evergreen Unicorn', '102257239631594', 'Huge', H, 24581057),
  makePet('Huge Clover Griffin', '129397965885657', 'Huge', H, 25194926),
  makePet('Huge Rudolf', '90192944578505', 'Huge', H, 25368676),
  makePet('Huge Hot Cocoa Cow', '94419678057049', 'Huge', H, 21983974),
  makePet('Huge Nebula Lion', '93555710520870', 'Huge', H, 24739913),
  makePet('Huge Clover Deer', '79851172093222', 'Huge', H, 23983769),
  makePet('Huge Chill Cat', '79287315277949', 'Huge', H, 25002608),
  makePet('Huge Cinnamon Bunny', '84468265134743', 'Huge', H, 25202802),
  makePet('Huge Clover Peacock', '109285154435259', 'Huge', H, 24161847),
  makePet('Huge Detective Terrier', '79798078989101', 'Huge', H, 24567438),
  makePet('Huge Evil Raven', '125919373287917', 'Huge', H, 21841228),
  makePet('Huge Green Cobra', '136758354491136', 'Huge', H, 23849696),
  makePet('Huge Mining Robot', '96864197207210', 'Huge', H, 24186117),
  makePet('Huge Basket Bunny', '75145545226238', 'Huge', H, 23768396),
  makePet('Huge Nutcracker Bunny', '134436276835311', 'Huge', H, 24201729),
  makePet('Huge Floatie Cat', '122328085750214', 'Huge', H, 24599921),
  makePet('Huge Beaver', '137999717729131', 'Huge', H, 24229278),
  makePet('Huge Royal Peacock', '87911299372812', 'Huge', H, 24356783),
  makePet('Huge Pixel Griffin', '95210896396972', 'Huge', H, 21628630),
  makePet('Huge Frankenpup Dog', '89649094845422', 'Huge', H, 24356145),
  makePet('Huge Ladybug', '99601574590476', 'Huge', H, 23900851),
  makePet('Huge Stingray', '74045348274896', 'Huge', H, 22958533),
  makePet('Huge Mining Monkey', '103555083432476', 'Huge', H, 21418334),
  makePet('Huge Sand Turtle', '135909325660471', 'Huge', H, 23739038),
  makePet('Huge Candycane Unicorn', '96812489225423', 'Huge', H, 23610423),
  makePet('Huge Wisp Griffin', '107709649476563', 'Huge', H, 20681186),
  makePet('Huge Safari Monkey', '131070721986590', 'Huge', H, 24488240),
  makePet('Huge Easter Lamb', '122710351430317', 'Huge', H, 22433238),
  makePet('Huge Elegant Eagle', '18556265741', 'Huge', H, 23386662),
  makePet('Huge Llama', '14976476776', 'Huge', H, 23814133),
  makePet('Huge Pastel Deer', '117144432225186', 'Huge', H, 24066408),
  makePet('Huge Pastel Sock Bunny', '85028487593165', 'Huge', H, 23882367),
  makePet('Huge Oracle Tiger', '86086397242289', 'Huge', H, 22130460),
  makePet('Huge Walrus', '102190929472921', 'Huge', H, 22523089),
  makePet('Huge Pixel Goblin', '122435473843216', 'Huge', H, 22892575),
  makePet('Huge Mushroom Pixie', '104120102100620', 'Huge', H, 21224503),
  makePet('Huge Festive Bear', '71088229378334', 'Huge', H, 23621136),
  makePet('Huge Merry Mule', '123118912547385', 'Huge', H, 24019985),
  ...
  makePet('Huge Chroma Phoenix', '79819458470257', 'Huge', H, 53511023),
  makePet('Huge Chroma Tiger', '95114398104330', 'Huge', H, 92539797),
  makePet('Huge Crowned Pegasus', '15281989490', 'Huge', H, 50000000),
  makePet('Huge Chroma Lucky Block Mimic', '15282013087', 'Huge', H, 307001619),
  makePet('Huge Chroma Snail', '99780016268743', 'Huge', H, 92247131),
  makePet('Huge Glass Crocodile', '85063221597865', 'Huge', H, 101481521),
  makePet('Huge Chroma Butterfly', '85411857304687', 'Huge', H, 91923278),
  makePet('Huge Empyrean Axolotl', '14976421410', 'Huge', H, 50000000),
  makePet('Huge Jelly Monkey', '16495814071', 'Huge', H, 625335277),
  makePet('Huge Cosmic Axolotl', '15201636161', 'Huge', H, 427709910),
  makePet('Huge Chroma Unicorn', '137010472014317', 'Huge', H, 548545076),
  makePet('Huge Jelly Axolotl', '16483328135', 'Huge', H, 663373971),
  makePet('Huge Jelly Corgi', '14976465933', 'Huge', H, 720556921),
  makePet('Huge Glass Dominus', '72368340879061', 'Huge', H, 306632647),
  makePet('Huge Owl', '15809137117', 'Huge', H, 50000000),
  makePet('Huge Chroma Doodle Axolotl', '104790531635237', 'Huge', H, 1060103447),
  makePet('Huge Cosmic Agony', '15201636010', 'Huge', H, 1212169230),
  makePet('Huge UV Cat', '18356987128', 'Huge', H, 46352399),
  makePet('Huge Ruinous Angelus', '101706886467940', 'Huge', H, 50000000),
  makePet('Huge Emoji Cat', '16047450864', 'Huge', H, 298013166),
  makePet('Huge Chroma Ink Blob', '109166274058146', 'Huge', H, 696628134),
  makePet('Huge Chroma Lucki', '14976381547', 'Huge', H, 178424483),
  makePet('Huge Pegasus', '14976514552', 'Huge', H, 50000000),
  makePet('Huge Chroma Swan', '109938539345401', 'Huge', H, 90354401),
  makePet('Huge Jelly Piggy', '14976467450', 'Huge', H, 1066635412),
];
